...
for i in np.arange(pkt_elems):
	p.append(ax[0,i].imshow(waterfall[:,:,i],aspect='auto',animated=True,origin='upper',interpolation='nearest', \
...
for i in np.arange(pkt_elems):
	p.append(ax[1,i].imshow(waterfold[:,:,i],aspect='auto',animated=True,origin='upper',interpolation='nearest', \
