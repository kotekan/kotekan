# From
# <https://raw.githubusercontent.com/xtensor-stack/xtensor-julia-cookiecutter/master/%7B%7Bcookiecutter.github_project_name%7D%7D/cmake/FindJulia.cmake>
...
execute_process(COMMAND ${Julia_EXECUTABLE} --version OUTPUT_VARIABLE Julia_VERSION_STRING)
...
execute_process(COMMAND ${Julia_SHARE_PATH}/julia-config.jl --cflags
...
execute_process(COMMAND ${Julia_SHARE_PATH}/julia-config.jl --ldflags
...
execute_process(COMMAND ${Julia_SHARE_PATH}/julia-config.jl --ldlibs
