                              ...
                              const    unsigned int   bit_shift_factor)
{
    ...
    //     if (FREQUENCY_BAND ==0){
    //         printf("%3i: angle: %10.6f sin: %10.6f cos: %10.6f\n",get_local_id(0)*4,phases[base_element_id]*freq,phase_im[0], phase_re[0]);
    //         printf("%3i: angle: %10.6f sin: %10.6f cos: %10.6f\n",get_local_id(0)*4+1,phases[base_element_id+1]*freq,phase_im[1], phase_re[1]);
    //         printf("%3i: angle: %10.6f sin: %10.6f cos: %10.6f\n",get_local_id(0)*4+2,phases[base_element_id+2]*freq,phase_im[2], phase_re[2]);
    //         printf("%3i: angle: %10.6f sin: %10.6f cos: %10.6f\n",get_local_id(0)*4+3,phases[base_element_id+3]*freq,phase_im[3], phase_re[3]);
    //     }
