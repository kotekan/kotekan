...
#define OPENCL_FILENAME_1                       "/home/pklages/dev/ch_gpu/pek_versions/gating/test0xB_multifreq_gating_multiple_outputs_2_bins_per2.cl" /* _optimizing1.cl .cl" */
#define OPENCL_FILENAME_2                       "/home/pklages/dev/ch_gpu/pek_versions/gating/offsetAccumulator_gating_multiple_outputs_2_bins_per.cl"
#define OPENCL_FILENAME_2b                      "/home/pklages/dev/ch_gpu/pek_versions/gating/offsetAccumulatorXOR_gating.cl"
#define OPENCL_FILENAME_3                       "/home/pklages/dev/ch_gpu/pek_versions/gating/preseed_multifreq_gating_multiple_outputs.cl"
...
#define NUM_TIMESAMPLES                         4*128*256//128u*8u*256u //
//#define NUM_REPEATS_GPU                         1000u

#define GATE_PERIOD_IN_10ns_UNITS               100000 // i.e. 100000 x 10ns = 1000000 ns = 1 ms
// ////////////////////////////////////////////////////////////////////////////////////
...
#define GEN_TYPE                                GENERATE_DATASET_RAMP_DOWN_WITH_TIME
...
int cpu_data_generate_and_correlate_gated_general_time_shifting(int num_timesteps, int num_frequencies, int num_elements, unsigned int *num_time_bins, unsigned int *bin_cutoff, int *correlated_data, int num_gate_groups, unsigned int *time_offset_remainder, unsigned int *single_gate_period,int num_elements_to_shift, int num_start_element, int num_time_bins_to_shift, int wrap){
    //correlatedData will be returned as num_frequencies blocks, each num_elements x num_elements x 2
...
int cpu_data_generate_and_correlate_upper_triangle_only_gated_general_time_shifting(int num_timesteps, int num_frequencies, int num_elements, unsigned int *num_time_bins, unsigned int *bin_cutoff, int *correlated_data_triangle, int num_gate_groups, unsigned int *time_offset_remainder, unsigned int *single_gate_period,int num_elements_to_shift, int num_start_element, int num_time_bins_to_shift, int wrap){
    //correlatedData will be returned as num_frequencies blocks, each num_elements x num_elements x 2
...
int main(int argc, char ** argv) {
    ...
    sprintf(cl_options,"-g -D NUM_BUFFERS=%d -D NUM_GATINGGROUPS=%d -D NUM_DATASETS=%d -D ACTUAL_NUM_ELEMENTS=%du -D ACTUAL_NUM_FREQUENCIES=%du -D NUM_ELEMENTS=%du -D NUM_FREQUENCIES=%du -D NUM_BLOCKS=%du -D NUM_TIMESAMPLES=%du -D BASE_TIMESAMPLES_INT_ACCUM=%d", NUM_GATING_GROUPS, NUM_DATA_SETS, ACTUAL_NUM_ELEM, ACTUAL_NUM_FREQ, NUM_ELEM, NUM_FREQ, num_blocks, NUM_TIMESAMPLES, BASE_TIMESAMPLES_ACCUM);// -O0 for optimization changes in compiler
    printf("Compiler Options: -g \n-D NUM_BUFFERS=%d \n-D NUM_GATINGGROUPS=%d \n-D NUM_DATASETS=%d \n-D ACTUAL_NUM_ELEMENTS=%du \n-D ACTUAL_NUM_FREQUENCIES=%du \n-D NUM_ELEMENTS=%du \n-D NUM_FREQUENCIES=%du \n-D NUM_BLOCKS=%du \n-D NUM_TIMESAMPLES=%du \n-D BASE_TIMESAMPLES_INT_ACCUM=%d \n", NUM_GATING_GROUPS, NUM_DATA_SETS, ACTUAL_NUM_ELEM, ACTUAL_NUM_FREQ, NUM_ELEM, NUM_FREQ, num_blocks, NUM_TIMESAMPLES, BASE_TIMESAMPLES_ACCUM);// -O0 for optimization changes in compiler
...
//                                   int            input_data_offset){
    ...
    */
    ...
    //cl_mem device_CLintermediate_input;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //    err = cpu_data_generate_and_correlate(NUM_TIMESAMPLES, ACTUAL_NUM_FREQ, ACTUAL_NUM_ELEM, correlated_CPU);
        ...
        if (UPPER_TRIANGLE){
            err = cpu_data_generate_and_correlate_upper_triangle_only_gated_general_time_shifting(NUM_TIMESAMPLES, ACTUAL_NUM_FREQ, ACTUAL_NUM_ELEM, num_time_bins, clip_bin, correlated_CPU,NUM_GATING_GROUPS,offset_remainder,gate_size_time,num_elem_to_shift,element_offset,time_bins_to_shift,1);
        }
        else{
            err = cpu_data_generate_and_correlate_gated_general_time_shifting(NUM_TIMESAMPLES, ACTUAL_NUM_FREQ, ACTUAL_NUM_ELEM, num_time_bins, clip_bin, correlated_CPU, NUM_GATING_GROUPS, offset_remainder,gate_size_time,num_elem_to_shift,element_offset,time_bins_to_shift,1);
        }
