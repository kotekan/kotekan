            ...
            const unsigned int delta_time_bin)
{
    ...
    //const uint block_id_x_2048 = (get_global_id(2) % NUM_BLOCKS) * 2048u;
...
//#pragma unroll 8
    ...
    addr_o *= NUM_FREQUENCIES * 2048;// num_blocks_x_2048;
    addr_o += (/*(block_id_x_2048) +*/ (LOCAL_Y * 256u) + (LOCAL_X * 8u)) + (FREQUENCY_BAND * 2048 /*num_blocks_x_2048*/);
