...
#define OPENCL_FILENAME_1               "/home/pklages/dev/ch_gpu/pek_versions/gating/test0xB_multifreq_gating_multiple_outputs_2_bins_per.cl" /* _optimizing1.cl .cl" */
...
#define NUM_ELEM                        256 //32u //minimum needs to be 32 for the kernels
#define NUM_FREQ                        1   //64u //63u
#define ACTUAL_NUM_ELEM                 256 //16u
#define ACTUAL_NUM_FREQ                 1   //128u //126u //product of ACTUAL_NUM_ELEM*ACTUAL_NUM_FREQ should equal NUM_ELEM*NUM_FREQ
#define HDF5_FREQ                       1   //1024 is too large when having 128 datasets and 1024 frequency bands for the 256 element correlator
...
//                                   (void *)&clip_bin);
            ...
            err = clEnqueueNDRangeKernel(queue[1],
                                         ...
                                         lws_corr,
                                         1,
                                         &lastWriteEvent[kernelStageIndex],//&preseedEvent,/*dependent on previous step so don't use &lastWriteEvent[kernelStageIndex],*/
