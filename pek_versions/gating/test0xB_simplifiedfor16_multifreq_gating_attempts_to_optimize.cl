...
//#pragma unroll 8
        for (uint j=0; j< LOCAL_SIZE; j++){
            ...
            corr_a = mad24(temp_pa, temp_stillPacked.s0000, corr_a);
            //corr_a += temp_pa*(uint)temp_stillPacked.s0;

            //corr_temp = temp_stillPacked.s1111;
            //corr_b=mad24(temp_pa, corr_temp, corr_b);
            corr_b=mad24(temp_pa, temp_stillPacked.s1111, corr_b);
            //corr_b += temp_pa*(uint)temp_stillPacked.s1;

            //corr_temp = temp_stillPacked.s2222;
            //corr_c=mad24(temp_pa, corr_temp, corr_c);
            corr_c=mad24(temp_pa, temp_stillPacked.s2222, corr_c);
            //corr_c += temp_pa*(uint)temp_stillPacked.s2;

            //corr_temp = temp_stillPacked.s3333;
            //corr_d=mad24(temp_pa, corr_temp, corr_d);
            corr_d=mad24(temp_pa, temp_stillPacked.s3333, corr_d);
            //corr_d += temp_pa*(uint)temp_stillPacked.s3;
            ...
            corr_e =mad24(temp_pa, temp_stillPacked.s0000, corr_e);
            //corr_e += temp_pa* (uint)temp_stillPacked.s0;

            //corr_temp = temp_stillPacked.s1111;
            //corr_f=mad24(temp_pa, corr_temp, corr_f);
            corr_f=mad24(temp_pa, temp_stillPacked.s1111, corr_f);
            //corr_f +=temp_pa*(uint) temp_stillPacked.s1;
            
            //corr_temp = temp_stillPacked.s2222;
            //corr_g=mad24(temp_pa, corr_temp, corr_g);
            corr_g=mad24(temp_pa, temp_stillPacked.s2222, corr_g);
            //corr_g+=temp_pa* (uint) temp_stillPacked.s2;
            
            //corr_temp = temp_stillPacked.s3333;
            //corr_h=mad24(temp_pa, corr_temp, corr_h);
            corr_h=mad24(temp_pa, temp_stillPacked.s3333, corr_h);
            //corr_h+=temp_pa*(uint)temp_stillPacked.s3;
        }
    }
