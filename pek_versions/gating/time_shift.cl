...
// __kernel void time_shift_part_a(__global unsigned char *data,
//                                 __global unsigned char *intermediate_array,
//                                 int num_elements_to_shift,
//                                 int num_time_bins_to_shift,
//                                 int offset){
//     int input_address = get_global_id(2)  * NUM_ELEMENTS * NUM_FREQUENCIES
//                         + get_local_id(1) * NUM_ELEMENTS
//                         + get_local_id(0);
// 
//     unsigned char input_value = data[input_address];
// 
//     int output_address = offset * NUM_TIMESAMPLES * NUM_FREQUENCIES * num_elements_to_shift
//                         + get_global_id(2) * num_elements_to_shift * NUM_FREQUENCIES
//                         + get_local_id(1) * num_elements_to_shift
//                         + get_local_id(0);
// 
//     intermediate_array[output_address] = input_value;
// }
// 
// __kernel void time_shift_part_b(__global unsigned char *data,
//                                 __global unsigned char *intermediate_array,
//                                 int num_elements_to_shift,
//                                 int num_time_bins_to_shift,
//                                 int offset){
//     int array_size = 2 * NUM_TIMESAMPLES * NUM_FREQUENCIES * num_elements_to_shift;
//     int input_address = offset * NUM_TIMESAMPLES * NUM_FREQUENCIES * num_elements_to_shift
//                         + (get_global_id(2) + num_time_bins_to_shift) * num_elements_to_shift * NUM_FREQUENCIES
//                         + get_local_id(1) * num_elements_to_shift
//                         + get_local_id(0);
// 
//     input_address = input_address % array_size; // correct for addresses beyond the end of the array
// 
//     if (input_address < 0) //check that the index is not negative
//         input_address += array_size; //correct the addresses for negative indices
// 
//     unsigned char input_value = intermediate_array[input_address];
// 
//     int output_address = get_global_id(2)  * NUM_ELEMENTS * NUM_FREQUENCIES
//                         + get_local_id(1) * NUM_ELEMENTS
//                         + get_local_id(0);
// 
//     data[output_address] = input_value;
// }


// element_offset is related to how far down the line the shifted elements exist.  element_offset = 0 would mean that the first num_elements_to_shift elements are shifted by num_time_bins_to_shift
...
//                         + (get_global_id(2) + (element_should_shift_a*element_should_shift_b)*(-num_time_bins_to_shift)) * NUM_FREQUENCIES * NUM_ELEMENTS
...
// //    input_address = input_address % (2*NUM_TIMESAMPLES*NUM_FREQUENCIES*NUM_ELEMENTS);
// 
//     //speed compare the simple alternates
// 
//     if (input_address<0)
//        input_address += 2*NUM_TIMESAMPLES*NUM_FREQUENCIES*NUM_ELEMENTS;
//     if (input_address >= 2*NUM_TIMESAMPLES*NUM_FREQUENCIES*NUM_ELEMENTS)
//        input_address -= 2*NUM_TIMESAMPLES*NUM_FREQUENCIES*NUM_ELEMENTS;
// 
// 
//     ///load data
