...
#define NUM_FREQ                        8   //64u //63u
#define ACTUAL_NUM_ELEM                 256 //16u
#define ACTUAL_NUM_FREQ                 8   //128u //126u //product of ACTUAL_NUM_ELEM*ACTUAL_NUM_FREQ should equal NUM_ELEM*NUM_FREQ
#define HDF5_FREQ                       8   //1024 is too large when having 128 datasets and 1024 frequency bands for the 256 element correlator
...
#define NUM_GATING_GROUPS               2 //will always be half of the number of Data sets...
