...
BOOST_FIXTURE_TEST_CASE( _general, CompareCTypes ) {
    ...
    const inputState* final_state =
            dm.dataset_state<inputState>(transformed_ds_id);
