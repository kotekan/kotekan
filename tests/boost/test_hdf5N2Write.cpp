...
// tables hold those rows in the N2 layout's element order. Elements 1 and 3 of the
// test telescope (CHORDBeamformer: element = dish + pol * 2) are the two polarizations
// of dish D01.
