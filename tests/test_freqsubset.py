...
def vis_data(tmpdir_factory):
    ...
    test = runner.KotekanStageTester("freqSubset", {}, fakevis_buffer, dump_buffer, params)
...
def write_data(tmpdir_factory):
    ...
    test = runner.KotekanStageTester("freqSubset", {}, fakevis_buffer, write_buffer, params)
