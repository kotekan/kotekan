...
__kernel void FFT64(__global float2 *data, int sign, __global float2 *results_array){
    ...
    //dummy1 = data[local_address + get_group_id(0)*128]; //first set of 64 numbers
    //dummy2 = data[local_address + get_group_id(0)*128 + 64]; //second sets
    ...
    //uint index2 = index1 + 1;
    float2 temp, temp1, temp2;
    temp1  = local_data[index1]; //load according to bit reversed addresses
...
//    }
    local_data[index1] = temp1+temp;
    local_data[index2] = temp1-temp;
    ...
    //results_array[get_local_id(0)+get_group_id(0)*128] = dummy1;// local_data[get_local_id(0)];
    //results_array[get_local_id(0) +get_group_id(0)*128  + 64] = dummy2;// local_data[get_local_id(0) + 64];
