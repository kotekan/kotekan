...
class CommandLine:
    ...
    def __init__(self):
        ...
        self.TCP_PORT = 2901
        self.config = {'samples_per_data_set':32768, 'timestep':2.56e-6, 'waterfallX': 1024, 'waterfallY': 1024, 'waterfall_request_delay': 30}
...
if( __name__ == '__main__'):
    ...
    im = plt.imshow(waterfall, aspect = 'auto',cmap='viridis',extent=[x_lims[0],x_lims[1],400,800], vmin=0,vmax=1)
    plt.colorbar()
    plt.xlabel("Time[s]")
