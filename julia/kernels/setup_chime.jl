...
# NOTE: We want _either_ U=16 _or_ U=128, but never both. This table here is just a hack.
const F_per_U = Dict(1 => 1, 2 => 1, 4 => 1, 8 => 1, 16 => 16, 32 => 1, 64 => 1, 128 => 16)
