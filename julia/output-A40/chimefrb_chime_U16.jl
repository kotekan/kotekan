    ...
    begin #= /home/eschnett/src/kotekan/julia/kernels/chimefrb.jl:1339 =#
        ...
        for time_outer in 0:24:24575
            ...
            I_memory[let
                ...
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((0::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ0
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((1::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ1
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((2::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ2
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((3::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ3
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((4::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ4
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((5::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ5
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((6::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ6
            I_memory[let
                offset = 524288 * Ttildemin
                length = 536870912
                mod((((((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2) ÷ 2) % 256 + ((7::Int32 % 8) % 8) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048) + 0) + offset, length)
            end + 0x01] = I_beamQ7
        end
        info = 0
        info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 256 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) % 8) * 32) + 0) + 0x01] =
