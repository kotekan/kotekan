...
#= /home/eschnett/src/kotekan/julia/kernels/chimefrb.jl:1340 =# @fastmath #= /home/eschnett/src/kotekan/julia/kernels/chimefrb.jl:1340 =# @inbounds(begin
            info = 1
            info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 256 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) % 32) + 0) + 0x01] = info
            ...
            for time_outer = 0:24:24575
                ...
                for time_inner = 0:1:23
                    (E_dish0, E_dish4) = IndexSpaces.unsafe_load2(E_memory, let
                                    ...
                                    length = 536870912
                                    mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 4) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 256 + ((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24 + IndexSpaces.assume_inrange(time_inner::Int32, 0, 1, 24) % 24) % 4096) * 131072) + offset, length)
                                end + 0x01)
                ...
                I_memory[let
                                ...
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((0::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ0
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((1::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ1
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((2::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ2
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((3::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ3
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((4::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ4
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((5::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ5
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((6::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ6
                I_memory[let
                                offset = 524288 * Ttildemin
                                length = 536870912
                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 2048 + (((((IndexSpaces.assume_inrange(time_outer::Int32, 0, 24, 24576) ÷ 24) % 1024) * 24) ÷ 24) % 1024) * 524288 + ((7::Int32 % 8) % 8) * 256) + 0) + offset, length)
                            end + 0x01] = I_beamQ7
            end
            info = 0
            info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 256 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) % 32) + 0) + 0x01] = info
