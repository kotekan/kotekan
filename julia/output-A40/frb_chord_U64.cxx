...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 24 * 24 * 2 * 1024;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 48 * 48 * 1024 * 64;
    ...
    static constexpr std::size_t info_length = chord_datatype_bytes(info_type) * 32 * 24 * 1024;
