...
private:
    ...
    static constexpr std::ptrdiff_t G_U32_length = type_total_bytes(G_U32_type) * 32;
    ...
    static constexpr std::ptrdiff_t Ebar_length =
        type_total_bytes(Ebar_type) * 1024 * 2 * 32 * 2048;
...
cudaUpchannelizer_chime_U32::cudaUpchannelizer_chime_U32(Config& config,
    ...
    if (instance_num == 0) {
        ...
        device.build_ptx(kernel_file_name, {kernel_symbol}, opts, "Upchannelizer_chime_U32_");
    }
...
cudaEvent_t cudaUpchannelizer_chime_U32::execute(cudaPipelineState& /*pipestate*/,
    ...
    *Ebar_meta = *E_meta;
    ...
    DEBUG("Running CUDA Upchannelizer_chime_U32 on GPU frame {:d}", gpu_frame_id);
    ...
    DEBUG("Finished CUDA Upchannelizer_chime_U32 on GPU frame {:d}", gpu_frame_id);
