            ...
            let
                ...
                let t_inner_hi = 0
                    for t_inner_lo in 0:4:23
                        ...
                        Gsh_shared[(((((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 2) * 4112 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + 0::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24) % 4) * 64 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) % 2) * 8256 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 16) % 2) * 514 + ((0::Int32 % 2) % 2) * 32 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 8) % 2) * 1028 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 32) % 2) * 257) + 0) + 0x01] =
                            G_cplx0_polr0_time0
                        Gsh_shared[(((((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 2) * 4112 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + 0::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24) % 4) * 64 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) % 2) * 8256 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 16) % 2) * 514 + ((0::Int32 % 2) % 2) * 32 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 8) % 2) * 1028 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 32) % 2) * 257) + 0) + 0x01] =
                            G_cplx1_polr0_time0
                        Gsh_shared[(((((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 2) * 4112 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + 0::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24) % 4) * 64 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) % 2) * 8256 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 16) % 2) * 514 + ((1::Int32 % 2) % 2) * 32 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 8) % 2) * 1028 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 32) % 2) * 257) + 0) + 0x01] =
                            G_cplx0_polr1_time0
                        Gsh_shared[(((((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 2) * 4112 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + 0::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24) % 4) * 64 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) % 2) * 8256 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 16) % 2) * 514 + ((1::Int32 % 2) % 2) * 32 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 8) % 2) * 1028 + (((1::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 32) % 2) * 257) + 0) + 0x01] =
                            G_cplx1_polr1_time0
                        ...
                        let t = 0
                            ...
                            if let
                                ...
                                G_beamQ0_polr0 = Gsh_shared[((((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + t::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + ((0::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ24_polr0 = Gsh_shared[((((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + t::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + ((0::Int32 % 2) % 2) * 32 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ0_polr1 = Gsh_shared[((((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + t::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + ((1::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ24_polr1 = Gsh_shared[((((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + t::Int32 % 4 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + ((1::Int32 % 2) % 2) * 32 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                            end
                                    ...
                                    if 0i32 ≤
                                       ...
                                       48
                                        I_memory[let
                                            ...
                                            length = 603979776
                                            mod(((((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 1024) % 1024) % 1024) * 589824 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 48) % 48) % 512) * 1152 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 48) * 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 24) + 0) + offset, length)
                                        end + 0x01] = I_beamQ0
                                    end
                                    if 0i32 ≤
                                       +(
                                       ...
                                       48
                                        I_memory[let
                                            offset = 589824 * Ttildemin + 1152 * Fbar_out_min
                                            length = 603979776
                                            mod(((((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 1024) % 1024) % 1024) * 589824 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 48) % 48) % 512) * 1152 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 48) * 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 24) + 0) + offset, length)
                                        end + 0x01] = I_beamQ24
                                    end
                                    I_beamQ0 = zero(Float16x2)
                                    I_beamQ24 = zero(Float16x2)
