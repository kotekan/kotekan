@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:824 =#
    info = 1
    info_memory[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)%32)%32+((IndexSpaces.assume_inrange(
    ...
    s = s_memory[((((IndexSpaces.assume_inrange(
        ...
        0,
        512,
    )÷32)%16)%16)*192+(((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_blockidx(),
        0,
        512,
        ...
        for T2 = 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                ...
                E_shared[((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    24,
                )%4)*128)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish0_time0
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    0,
                    24,
                )%4)*128)+4)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                )÷4)%4)*4+(IndexSpaces.assume_inrange(
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish4_time0
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    0,
                    24,
                )%4)*128)+8)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                )÷4)%4)*4+(IndexSpaces.assume_inrange(
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish8_time0
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    0,
                    24,
                )%4)*128)+12)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                )÷4)%4)*4+(IndexSpaces.assume_inrange(
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish0_time16
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish4_time16
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish8_time16
                E_shared[(((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*129)+0+0x01] = E_dish12_time16
            end
                ...
                let
                    ...
                    let
                        ...
                        E0 = E_shared[(((((IndexSpaces.assume_inrange(
                            ...
                            0,
                            32,
                        )%4)*32)+((D÷4)%8)*4)÷4)%128+(((((((IndexSpaces.assume_inrange(
                            T3,
                            0,
                            8,
                            32,
                    ...
                    Ju_shared[(((((IndexSpaces.assume_inrange(
                        ...
                        128,
                        2048,
                    )÷128)%16)*128)%32)*100+((((B÷8)%2)*8+(IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_threadidx(),
                        0,
                        32,
                    )÷4)%8)+((IndexSpaces.assume_inrange(
                        ...
                        0,
                        24,
                    )÷4)%6)*16)%96)+0+0x01] = Ju_time0
                    Ju_shared[(((((IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_warpidx(),
                        0,
                        24,
                    )%4)*128)÷128)%4)*3200+((((((1+((IndexSpaces.assume_inrange(
                        T3,
                        0,
                        8,
                        32,
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(0+((((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
                ...
                128,
                2048,
            )÷128)%16)*128)%32)*100+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_warpidx(),
                0,
                24,
            )%24)*4+(IndexSpaces.assume_inrange(
            ...
            Ju_dish128_time0 = Ju_shared[(3200+((((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8+(IndexSpaces.assume_inrange(
            ...
            Ju_dish256_time0 = Ju_shared[(6400+((((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8+(IndexSpaces.assume_inrange(
            ...
            Ju_dish384_time0 = Ju_shared[(9600+((((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8+(IndexSpaces.assume_inrange(
            ...
            Ju_dish0_time8 = Ju_shared[(0+(((((8+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish128_time8 = Ju_shared[(3200+(((((8+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish256_time8 = Ju_shared[(6400+(((((8+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish384_time8 = Ju_shared[(9600+(((((8+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish0_time16 = Ju_shared[(0+(((((16+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish128_time16 = Ju_shared[(3200+(((((16+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish256_time16 = Ju_shared[(6400+(((((16+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish384_time16 = Ju_shared[(9600+(((((16+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish0_time24 = Ju_shared[(0+(((((24+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish128_time24 = Ju_shared[(3200+(((((24+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish256_time24 = Ju_shared[(6400+(((((24+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_dish384_time24 = Ju_shared[(9600+(((((24+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
