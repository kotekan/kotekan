...
@fastmath @inbounds(
    begin #= /home/eschnett/src/kotekan/julia/kernels/frb.jl:1874 =#
        ...
        if let
            ...
            W_dishM0_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 384) % 384) % 128) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((0::Int32 % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 8) + 0x01]
            W_dishM4_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 384) % 384) % 128) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((0::Int32 % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 8) + 0x01]
            W_dishM0_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 384) % 384) % 128) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((1::Int32 % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 8) + 0x01]
            W_dishM4_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 384) % 384) % 128) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((1::Int32 % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 8) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:48:32735
            ...
            let
                Freg1_dish0 = Fsh1_shared[(((((0::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((0::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish6 = Fsh1_shared[(((((6::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((6::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish12 = Fsh1_shared[(((((12::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((12::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish18 = Fsh1_shared[(((((18::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((18::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((((24::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((24::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish30 = Fsh1_shared[(((((30::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((30::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish36 = Fsh1_shared[(((((36::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((36::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish42 = Fsh1_shared[(((((42::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((42::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((((48::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((48::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish54 = Fsh1_shared[(((((54::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((54::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                Freg1_dish60 = Fsh1_shared[(((((60::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (((((60::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time0 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((0::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time3 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((3::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time6 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((6::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time9 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((9::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time12 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((12::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time15 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((15::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    Freg2_dishM4_time15 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((15::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    Freg2_dishM0_time18 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((18::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                    ...
                    Freg2_dishM0_time21 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((21::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290) + 0x01]
                ...
                let t_inner_hi = 0
                    for t_inner_lo in 0:6:23
                        ...
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM0_polr0_time0
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                        ...
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM0_polr1_time0
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx1_dishM0_polr1_time0
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM4_polr1_time0
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((0::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx1_dishM4_polr1_time0
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM0_polr0_time3
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx1_dishM0_polr0_time3
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM4_polr0_time3
                        Gsh_shared[((((0::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((4::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx1_dishM4_polr0_time3
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
                            G_cplx0_dishM0_polr1_time3
                        Gsh_shared[((((1::Int32 % 2) % 2) * 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 98 + ((((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 32736) ÷ 48) % 682) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3) % 6) * 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 784 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2 + ((0::Int32 ÷ 4) % 2) * 4) % 8) + 0) + 0x01] =
