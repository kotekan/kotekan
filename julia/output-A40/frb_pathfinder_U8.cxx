...
private:
    ...
    static constexpr std::size_t W_U8_length =
        chord_datatype_bytes(W_U8_type) * 2 * 8 * 12 * 2 * 512;
    ...
    static constexpr std::size_t Ebar_U8_length =
        chord_datatype_bytes(Ebar_U8_type) * 64 * 2 * 512 * 4096;
    ...
    static constexpr std::size_t I_U8_length =
        chord_datatype_bytes(I_U8_type) * 16 * 24 * 512 * 1024;
    ...
    static constexpr std::array<std::ptrdiff_t, I_U8_rank + 1> I_U8_strides = {
        ...
        I_U8_calc_stride(I_U8_index_Fbar_U8), I_U8_calc_stride(I_U8_index_Ttilde_U8_Tds32),
    ...
    static constexpr std::size_t I_U8_Ttilde_U8_Tds32_sample_bytes =
...
int cudaFRBBeamformer_pathfinder_U8::wait_on_precondition() {
    ...
    // to bytes
    const std::size_t output_bytes = Ttildelength * I_U8_Ttilde_U8_Tds32_sample_bytes;
    ...
    assert(mod(output_cursor, I_U8_Ttilde_U8_Tds32_sample_bytes) == 0);
    Ttildemin = output_cursor / I_U8_Ttilde_U8_Tds32_sample_bytes;
...
cudaFRBBeamformer_pathfinder_U8::execute(cudaPipelineState& /*pipestate*/,
    ...
    *I_U8_meta = *Ebar_U8_meta;
    ...
    const std::size_t Ttilde_ringbuf =
        output_ringbuf_signal->size / I_U8_Ttilde_U8_Tds32_sample_bytes;
    ...
    // Update metadata
    I_U8_meta->dim[I_U8_rank - 1 - I_U8_index_Ttilde_U8_Tds32] = Ttildelength;
    assert(I_U8_meta->dim[I_U8_rank - 1 - I_U8_index_Ttilde_U8_Tds32]
           <= int(I_U8_lengths[I_U8_index_Ttilde_U8_Tds32]));
...
void cudaFRBBeamformer_pathfinder_U8::finalize_frame() {
    ...
    DEBUG("    Produced bytes:   {:d}", Ttilde_produced * I_U8_Ttilde_U8_Tds32_sample_bytes);
    output_ringbuf_signal->finish_write(unique_name, instance_num,
                                        Ttilde_produced * I_U8_Ttilde_U8_Tds32_sample_bytes);
