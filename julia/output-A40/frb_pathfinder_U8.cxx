...
private:
    ...
    static constexpr std::size_t W8_length = chord_datatype_bytes(W8_type) * 2 * 8 * 12 * 2 * 3072;
    ...
    static constexpr std::size_t Ebar8_length =
        chord_datatype_bytes(Ebar8_type) * 64 * 2 * 3072 * 4096;
    ...
    static constexpr std::size_t I8_length = chord_datatype_bytes(I8_type) * 16 * 24 * 3072 * 512;
