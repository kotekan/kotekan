...
private:
    ...
    static constexpr std::size_t E_length = chord_datatype_bytes(E_type) * 256 * 2 * 64 * 32768;
    ...
    static constexpr std::size_t J_length = chord_datatype_bytes(J_type) * 32768 * 2 * 64 * 16;
