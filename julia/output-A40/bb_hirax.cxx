...
private:
    ...
    static constexpr std::ptrdiff_t A_length = chord_datatype_bytes(A_type) * 2 * 256 * 16 * 2 * 64;
    ...
    static constexpr std::ptrdiff_t s_length = chord_datatype_bytes(s_type) * 16 * 2 * 64;
    ...
    static constexpr std::ptrdiff_t J_length = chord_datatype_bytes(J_type) * 2048 * 2 * 64 * 16;
