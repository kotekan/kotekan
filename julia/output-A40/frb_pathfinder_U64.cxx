...
private:
    ...
    static constexpr int cuda_number_of_frequencies = 24576;
    ...
    static constexpr int blocks = 24576;
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 8 * 12 * 2 * 24576;
    ...
    static constexpr std::size_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 64 * 2 * 24576 * 512;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 16 * 24 * 24576 * 64;
    ...
    static constexpr std::size_t info_length = chord_datatype_bytes(info_type) * 32 * 6 * 24576;
