/**
 * @file
 * @brief CUDA Upchannelizer_smallfinder_U16 kernel
 *
...
/**
 * @class cudaUpchannelizer_smallfinder_U16
 * @brief cudaCommand for Upchannelizer_smallfinder_U16
 */
class cudaUpchannelizer_smallfinder_U16 : public cudaCommand {
public:
    cudaUpchannelizer_smallfinder_U16(Config& config, const std::string& unique_name,
                                      bufferContainer& host_buffers, cudaDeviceInterface& device,
                                      const int instance_num);
    virtual ~cudaUpchannelizer_smallfinder_U16();
...
REGISTER_CUDA_COMMAND(cudaUpchannelizer_smallfinder_U16);

cudaUpchannelizer_smallfinder_U16::cudaUpchannelizer_smallfinder_U16(Config& config,
    ...
    dummy() // avoid trailing comma
{
    ...
    if (instance_num == 0) {
        ...
        device.build_ptx("lib/cuda/generated/Upchannelizer_smallfinder_U16.ptx", {kernel_symbol},
                         opts, "Upchannelizer_smallfinder_U16_");
    }
}

cudaUpchannelizer_smallfinder_U16::~cudaUpchannelizer_smallfinder_U16() {}

std::int64_t cudaUpchannelizer_smallfinder_U16::num_consumed_elements(
...
std::int64_t cudaUpchannelizer_smallfinder_U16::num_produced_elements(
    std::int64_t num_available_elements) const {
...
std::int64_t cudaUpchannelizer_smallfinder_U16::num_processed_elements(
    std::int64_t num_available_elements) const {
    return round_down(num_available_elements, cuda_granularity_number_of_timesamples);
}

int cudaUpchannelizer_smallfinder_U16::wait_on_precondition() {
    {
...
cudaEvent_t
cudaUpchannelizer_smallfinder_U16::execute(cudaPipelineState& /*pipestate*/,
...
void cudaUpchannelizer_smallfinder_U16::finalize_frame() {
