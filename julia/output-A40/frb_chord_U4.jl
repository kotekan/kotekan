    ...
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1891 =#
        ...
        if !(
            0i32 ≤ Tmin < 8192 && (
                Tmin ≤ Tmax < 16384 && (
                    (Tmax - Tmin) % 48 == 0i32 &&
                    (0i32 ≤ T̄min < 512 && (T̄min ≤ T̄max < 1024 && T̄max - T̄min == (Tmax - Tmin) ÷ 64))
                )
            )
        )
            info = 2
        ...
        if !(
            0i32 ≤ Fmin ≤ Fmax ≤ 64 && (
                (Fmax - Fmin) % 4 == 0i32 &&
                (0i32 ≤ F̄min ≤ F̄max ≤ 512 && ((F̄max - F̄min) % 4 == 0i32 && F̄max - F̄min == Fmax - Fmin))
            )
        )
            info = 3
            if true
        ...
        for t_outer in 0:48:8159
            ...
            let
                ...
                if true
                    Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    Fsh1_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish256_time0
                end
                if true
                    Fsh1_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish260_time0
                end
                if true
                    Fsh1_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish264_time0
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + 256) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish268_time0
                end
                if true
                    Fsh1_shared[(((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish0_time24
                end
                if true
                    Fsh1_shared[((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish4_time24
                end
                if true
                    Fsh1_shared[((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish8_time24
                end
                if true
                    Fsh1_shared[(((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish12_time24
                end
                if true
                    Fsh1_shared[((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish256_time24
                end
                if true
                    Fsh1_shared[(((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish260_time24
                end
                if true
                    Fsh1_shared[(((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish264_time24
                end
                if true
                    Fsh1_shared[((((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 256) + 2) + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) ÷ 8) % 64) * 257) + 0) + 0x01] =
                        E_dish268_time24
                end
                IndexSpaces.cuda_sync_threads()
            end
            let
                Freg1_dish0 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish72 = Fsh1_shared[(((72 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((72 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish96 = Fsh1_shared[(((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish120 = Fsh1_shared[(((120 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((120 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish144 = Fsh1_shared[(((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish168 = Fsh1_shared[(((168 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((168 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish192 = Fsh1_shared[(((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish216 = Fsh1_shared[(((216 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((216 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish240 = Fsh1_shared[(((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish264 = Fsh1_shared[(((264 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((264 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish288 = Fsh1_shared[(((288 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((288 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish312 = Fsh1_shared[(((312 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((312 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish336 = Fsh1_shared[(((336 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((336 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish360 = Fsh1_shared[(((360 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((360 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish384 = Fsh1_shared[(((384 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((384 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish408 = Fsh1_shared[(((408 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((408 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish432 = Fsh1_shared[(((432 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((432 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish456 = Fsh1_shared[(((456 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((456 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish480 = Fsh1_shared[(((480 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((480 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                Freg1_dish504 = Fsh1_shared[(((504 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + (((504 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_time0 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time1 = Fsh2_shared[((1 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time2 = Fsh2_shared[((2 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time3 = Fsh2_shared[((3 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time4 = Fsh2_shared[((4 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time5 = Fsh2_shared[((5 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time6 = Fsh2_shared[((6 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time7 = Fsh2_shared[((7 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time8 = Fsh2_shared[((8 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time9 = Fsh2_shared[((9 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time10 = Fsh2_shared[((10 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time11 = Fsh2_shared[((11 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time12 = Fsh2_shared[((12 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time13 = Fsh2_shared[((13 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time14 = Fsh2_shared[((14 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time15 = Fsh2_shared[((15 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time16 = Fsh2_shared[((16 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time17 = Fsh2_shared[((17 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time18 = Fsh2_shared[((18 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time19 = Fsh2_shared[((19 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time20 = Fsh2_shared[((20 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time21 = Fsh2_shared[((21 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time22 = Fsh2_shared[((22 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time23 = Fsh2_shared[((23 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                end
                IndexSpaces.cuda_sync_threads()
                let
                    t_inner_hi = 0
                    for t_inner_lo in 0:4:23
                        ...
                        let
                            ...
                            if let
                                ...
                                G_beamQ0_polr0 = Gsh_shared[(0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 32) % 2) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 2) * 8256 + ((((((IndexSpaces.assume_inrange(t_inner_lo, 0, 4, 24) ÷ 4) % 6) * 4 + t % 4) + ((t_inner_hi ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 2) % 2) * 4112 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 4) % 2) * 2056 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 16) % 2) * 514 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 6) + 0x01]
                                G_beamQ24_polr0 = Gsh_shared[(0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 32) % 2) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) % 2) * 8256 + ((((((IndexSpaces.assume_inrange(t_inner_lo, 0, 4, 24) ÷ 4) % 6) * 4 + t % 4) + ((t_inner_hi ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 2) % 2) * 4112 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 4) % 2) * 2056 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 16) % 2) * 514 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 6) + 0x01]
                            ...
                            I_beamQ0 = muladd(
                                Float16x2(0.001953125f0, 0.001953125f0),
                                muladd(
                                    Ẽp1im_beamQ0,
                                    Ẽp1im_beamQ0,
                                    muladd(
