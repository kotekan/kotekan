                    ...
                    for t_inner_lo in 0:4:23
                        ...
                        let t = 0
                            ...
                            if let
                                ...
                                G_beamQ0_polr0 = Gsh_shared[(((0::Int32 % 2) % 2) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 32) % 2) * 257 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 16) % 2) * 514 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 2) % 2) * 4112 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 4) % 2) * 2056 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 8) % 2) * 1028 + ((((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) + t::Int32 % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) % 2) * 8256) + 0x01]
                                G_beamQ24_polr0 = Gsh_shared[(((0::Int32 % 2) % 2) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 32) % 2) * 257 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 16) % 2) * 514 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 2) % 2) * 4112 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 4) % 2) * 2056 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 8) % 2) * 1028 + ((((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) + t::Int32 % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) % 2) * 8256) + 0x01]
                                G_beamQ0_polr1 = Gsh_shared[(((1::Int32 % 2) % 2) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 32) % 2) * 257 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 16) % 2) * 514 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 2) % 2) * 4112 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 4) % 2) * 2056 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) ÷ 8) % 2) * 1028 + ((((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) + t::Int32 % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((0::Int32 ÷ 24) % 2) * 24) % 2) * 8256) + 0x01]
                                G_beamQ24_polr1 = Gsh_shared[(((1::Int32 % 2) % 2) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 32) % 2) * 257 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 16) % 2) * 514 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 2) % 2) * 4112 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 4) % 2) * 2056 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) ÷ 8) % 2) * 1028 + ((((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4 + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) + t::Int32 % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24 + ((24::Int32 ÷ 24) % 2) * 24) % 2) * 8256) + 0x01]
                            end
