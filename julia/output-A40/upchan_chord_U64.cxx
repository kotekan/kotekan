...
private:
    ...
    static constexpr std::ptrdiff_t G_U64_length = chord_datatype_bytes(G_U64_type) * 256;
...
cudaEvent_t cudaUpchannelizer_chord_U64::execute(cudaPipelineState& /*pipestate*/,
    ...
    *Ebar_meta = *E_meta;
    ...
    DEBUG("Finished CUDA Upchannelizer_chord_U64 on GPU frame {:d}", gpu_frame_id);
