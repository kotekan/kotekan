...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1891 =#
        ...
        for t_outer in 0:48:239
            ...
            let
                Freg1_dish0 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish72 = Fsh1_shared[(((72 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((72 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish96 = Fsh1_shared[(((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish120 = Fsh1_shared[(((120 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((120 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish144 = Fsh1_shared[(((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish168 = Fsh1_shared[(((168 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((168 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish192 = Fsh1_shared[(((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish216 = Fsh1_shared[(((216 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((216 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish240 = Fsh1_shared[(((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish264 = Fsh1_shared[(((264 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((264 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish288 = Fsh1_shared[(((288 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((288 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish312 = Fsh1_shared[(((312 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((312 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish336 = Fsh1_shared[(((336 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((336 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish360 = Fsh1_shared[(((360 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((360 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish384 = Fsh1_shared[(((384 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((384 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish408 = Fsh1_shared[(((408 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((408 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish432 = Fsh1_shared[(((432 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((432 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish456 = Fsh1_shared[(((456 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((456 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish480 = Fsh1_shared[(((480 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((480 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                Freg1_dish504 = Fsh1_shared[(((504 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 8) * 32 + (((504 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 64) * 257 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd0) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish24
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd1) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish48
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd2) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish72
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd3) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish96
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd4) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish120
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd5) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish144
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd6) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish168
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd7) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish192
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd8) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish216
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd9) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish240
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd10) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish264
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd11) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish288
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd12) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish312
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd13) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish336
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd14) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish360
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd15) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish384
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd16) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish408
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd17) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish432
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd18) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish456
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd19) + 0x01] =
                        Freg1′
                end
                Freg1′ = Freg1_dish480
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd20) + 0x01] =
                        Freg1′
                end
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd21) + 0x01] =
                        Freg1′
                end
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd22) + 0x01] =
                        Freg1′
                end
                Freg1′ = Int4x8(0, 0, 0, 0, 0, 0, 0, 0)
                ...
                if true
                    Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24) % 24 + sd_sd23) + 0x01] =
                        Freg1′
                end
                IndexSpaces.cuda_sync_threads()
            end
            let
                ...
                if let
                    ...
                    Freg2_time0 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time1 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 1) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time2 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 2) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time3 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time4 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 4) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time5 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 5) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time6 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 6) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time7 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 7) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time8 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 8) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time9 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 9) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time10 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 10) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time11 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 11) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time12 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 12) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time13 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 13) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time14 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 14) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time15 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 15) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time16 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 16) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time17 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 17) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time18 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 18) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time19 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 19) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time20 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 20) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time21 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 21) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time22 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 22) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                    Freg2_time23 = Fsh2_shared[((((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48 + 23) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6) * 801 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 4806) + 0x01]
                end
                IndexSpaces.cuda_sync_threads()
                let
                    t_inner_hi = 0
                    for t_inner_lo in 0:4:23
                        ...
                        let
                            ...
                            if let
                                ...
                                G_beamQ0_polr0 = Gsh_shared[(0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 32) % 2) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 2) * 8256 + ((((((IndexSpaces.assume_inrange(t_inner_lo, 0, 4, 24) ÷ 4) % 6) * 4 + t % 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48) + ((t_inner_hi ÷ 24) % 2) * 24) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 2) % 2) * 4112 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 4) % 2) * 2056 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 16) % 2) * 514 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 6) + 0x01]
                                G_beamQ24_polr0 = Gsh_shared[(0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 32) % 2) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) % 2) * 8256 + ((((((IndexSpaces.assume_inrange(t_inner_lo, 0, 4, 24) ÷ 4) % 6) * 4 + t % 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 240) ÷ 48) % 5) * 48) + ((t_inner_hi ÷ 24) % 2) * 24) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 2) % 2) * 4112 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 6 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 4) % 2) * 2056 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 16) % 2) * 514 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24 + 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 6) + 0x01]
