...
@fastmath @inbounds(
    begin #= /home/eschnett/src/kotekan/julia/kernels/frb.jl:1874 =#
        ...
        for t_outer in 0:48:1007
            ...
            let
                Freg1_dish0 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((0::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((0::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish6 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((6::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((6::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish12 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((12::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((12::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish18 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((18::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((18::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((24::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((24::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish30 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((30::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((30::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish36 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((36::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((36::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish42 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((42::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((42::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((48::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((48::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish54 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((54::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((54::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish60 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((60::Int32 ÷ 6) % 11) * 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6 + ((60::Int32 ÷ 6) % 11) * 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time3 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((3::Int32 ÷ 3) % 8) * 3) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time6 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((6::Int32 ÷ 3) % 8) * 3) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time12 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((12::Int32 ÷ 3) % 8) * 3) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time21 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((21::Int32 ÷ 3) % 8) * 3) % 24) + 0x01]
                ...
                let t_inner_hi = 0
                    for t_inner_lo in 0:6:23
                        ...
                        Gsh_shared[(((((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 16) % 2) * 98 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 2) % 2) * 784 + ((0::Int32 % 2) % 2) * 8 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 4) % 2) * 392 + ((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) % 2) * 1576 + (((0::Int32 % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 8) % 2) * 196 + (((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 8 + ((((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 6, 24) ÷ 6) % 4) * 6 + ((3::Int32 ÷ 3) % 2) * 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 24, 48) ÷ 24) % 2) * 24) % 6) * 16) + 0) + 0x01] =
