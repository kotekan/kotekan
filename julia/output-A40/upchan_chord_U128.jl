...
@fastmath @inbounds(
    begin #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:1397 =#
        ...
        (Γ¹0, Γ¹1) = let
            k = 7
            @assert 128 == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:663 =#
            m = 3
            n = k - m
        ...
        (Γ²0, Γ²1) = let
            k = 7
            @assert 128 == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:741 =#
            m = 3
            n = k - m
        ...
        (Γ³0, Γ³1) = let
            k = 7
            @assert 128 == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:806 =#
            m = 3
            n = k - m
        ...
        (Γ⁴0, Γ⁴1) = let
            k = Ubits
            @assert U == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:909 =#
            m = 6
            n = k - m
            @assert 0 ≤ m                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:912 =#
            @assert 0 ≤ n                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:913 =#
            thread = IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)
            thread0 = (thread ÷ (1i32)) % (2i32)
            thread1 = (thread ÷ (2i32)) % (2i32)
            thread2 = (thread ÷ (4i32)) % (2i32)
