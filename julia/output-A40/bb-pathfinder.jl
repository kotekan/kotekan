@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:824 =#
    info = 1
    info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4)%4)%4)*32+(IndexSpaces.assume_inrange(
        ...
        0,
        2048,
    )%2048)%2048)*128)+0+0x01] = info
    s_polr0 = s_memory[(0+(((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_blockidx(),
        0,
        2048,
    )÷16)%128)%128)*32+((IndexSpaces.assume_inrange(
    ...
    s_polr1 = s_memory[(16+(((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_blockidx(),
        0,
        2048,
    )÷16)%128)%128)*32+((IndexSpaces.assume_inrange(
        ...
        for T2 = 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                ...
                E_shared[((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish0_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*17+((4+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish4_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*17+((8+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish8_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    128,
                    2048,
                )÷128)%16)*128)%32)*17+((12+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                )÷2)%2)%2)*544+((((((8+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )÷4)%8)+(IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish0_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish4_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish8_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )%4)*16)÷4)%16)+0+0x01] = E_dish12_time8
            end
                ...
                let
                    ...
                    let
                        ...
                        E0 = E_shared[((((IndexSpaces.assume_inrange(
                            ...
                            128,
                            2048,
                        )÷128)%16)*128)%32)*17+((((D÷4)%4)*4+(IndexSpaces.assume_inrange(
                            IndexSpaces.cuda_threadidx(),
                            0,
                            32,
                        )%4)*16)÷4)%16)+0x01]
                    ...
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        ...
                        128,
                        2048,
                    )÷128)%16)*128)%32)*20)+0+0x01] = Ju_time0
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_warpidx(),
                        0,
                        4,
                        ...
                        0,
                        32,
                    )÷4)%8)%16+((((((1+((IndexSpaces.assume_inrange(
                        T3,
                        0,
                        8,
                        32,
                        ...
                        128,
                        2048,
                    )÷128)%16)*128)%32)*20)+0+0x01] = Ju_time1
                end
            end
            IndexSpaces.cuda_sync_threads()
            Ju_polr0_time0 = Ju_shared[(0+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
                ...
                128,
                2048,
            )÷128)%16)*128)%32)*20)+0x01]
            Ju_polr1_time0 = Ju_shared[(640+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
            ...
            Ju_polr0_time8 = Ju_shared[(0+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
                ...
                0,
                4,
            )%4)*4)%16+(((((8+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_polr1_time8 = Ju_shared[(640+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
            ...
            Ju_polr0_time16 = Ju_shared[(0+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
                ...
                0,
                4,
            )%4)*4)%16+(((((16+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_polr1_time16 = Ju_shared[(640+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
            ...
            Ju_polr0_time24 = Ju_shared[(0+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
                ...
                0,
                4,
            )%4)*4)%16+(((((24+IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )%8)+(IndexSpaces.assume_inrange(
            ...
            Ju_polr1_time24 = Ju_shared[(640+((IndexSpaces.assume_inrange(
                IndexSpaces.cuda_threadidx(),
                0,
                32,
            )÷8)%4+(IndexSpaces.assume_inrange(
            ...
            (Ju_cplx0_polr1_time0, Ju_cplx1_polr1_time0) =
                convert(NTuple{2,Int32}, Ju_polr1_time0)
            (Ju_cplx0_polr0_time8, Ju_cplx1_polr0_time8) =
                convert(NTuple{2,Int32}, Ju_polr0_time8)
            (Ju_cplx0_polr1_time8, Ju_cplx1_polr1_time8) =
                convert(NTuple{2,Int32}, Ju_polr1_time8)
            (Ju_cplx0_polr0_time16, Ju_cplx1_polr0_time16) =
                convert(NTuple{2,Int32}, Ju_polr0_time16)
            (Ju_cplx0_polr1_time16, Ju_cplx1_polr1_time16) =
                convert(NTuple{2,Int32}, Ju_polr1_time16)
            (Ju_cplx0_polr0_time24, Ju_cplx1_polr0_time24) =
                convert(NTuple{2,Int32}, Ju_polr0_time24)
            (Ju_cplx0_polr1_time24, Ju_cplx1_polr1_time24) =
                convert(NTuple{2,Int32}, Ju_polr1_time24)
            ...
            J_cplx0_polr0_time0 =
                (J_cplx0_polr0_time0 + 1 << (s_polr0 % UInt32 - 0x01)) >> (s_polr0 % UInt32)
            J_cplx1_polr0_time0 =
                (J_cplx1_polr0_time0 + 1 << (s_polr0 % UInt32 - 0x01)) >> (s_polr0 % UInt32)
            J_cplx0_polr1_time0 =
                (J_cplx0_polr1_time0 + 1 << (s_polr1 % UInt32 - 0x01)) >> (s_polr1 % UInt32)
            J_cplx1_polr1_time0 =
                (J_cplx1_polr1_time0 + 1 << (s_polr1 % UInt32 - 0x01)) >> (s_polr1 % UInt32)
            J_cplx0_polr0_time8 =
                (J_cplx0_polr0_time8 + 1 << (s_polr0 % UInt32 - 0x01)) >> (s_polr0 % UInt32)
            J_cplx1_polr0_time8 =
                (J_cplx1_polr0_time8 + 1 << (s_polr0 % UInt32 - 0x01)) >> (s_polr0 % UInt32)
            J_cplx0_polr1_time8 =
                (J_cplx0_polr1_time8 + 1 << (s_polr1 % UInt32 - 0x01)) >> (s_polr1 % UInt32)
            J_cplx1_polr1_time8 =
                (J_cplx1_polr1_time8 + 1 << (s_polr1 % UInt32 - 0x01)) >> (s_polr1 % UInt32)
            J_cplx0_polr0_time16 =
                (J_cplx0_polr0_time16 + 1 << (s_polr0 % UInt32 - 0x01)) >>
                (s_polr0 % UInt32)
            J_cplx1_polr0_time16 =
                (J_cplx1_polr0_time16 + 1 << (s_polr0 % UInt32 - 0x01)) >>
                (s_polr0 % UInt32)
            J_cplx0_polr1_time16 =
                (J_cplx0_polr1_time16 + 1 << (s_polr1 % UInt32 - 0x01)) >>
                (s_polr1 % UInt32)
            J_cplx1_polr1_time16 =
                (J_cplx1_polr1_time16 + 1 << (s_polr1 % UInt32 - 0x01)) >>
                (s_polr1 % UInt32)
            J_cplx0_polr0_time24 =
                (J_cplx0_polr0_time24 + 1 << (s_polr0 % UInt32 - 0x01)) >>
                (s_polr0 % UInt32)
            J_cplx1_polr0_time24 =
                (J_cplx1_polr0_time24 + 1 << (s_polr0 % UInt32 - 0x01)) >>
                (s_polr0 % UInt32)
            J_cplx0_polr1_time24 =
                (J_cplx0_polr1_time24 + 1 << (s_polr1 % UInt32 - 0x01)) >>
                (s_polr1 % UInt32)
            J_cplx1_polr1_time24 =
                (J_cplx1_polr1_time24 + 1 << (s_polr1 % UInt32 - 0x01)) >>
                (s_polr1 % UInt32)
