...
cudaUpchannelizer_pathfinder_U16::cudaUpchannelizer_pathfinder_U16(Config& config,
    ...
    output_ringbuf_signal(dynamic_cast<RingBuffer*>(host_buffers.get_generic_buffer(
        config.get<std::string>(unique_name, "upchan_U16_voltage_signal_out")))),
    ...
    gpu_buffers_used.push_back(std::make_tuple(G_U16_name, true, true, false));
...
cudaUpchannelizer_pathfinder_U16::execute(cudaPipelineState& /*pipestate*/,
    ...
    const std::string G_U16_memname = G_U16_name + "_buffer";
    ...
    assert(std::strncmp(G_U16_meta->name, G_U16_quantity, sizeof G_U16_meta->name) == 0);
