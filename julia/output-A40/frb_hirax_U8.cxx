...
private:
    ...
    static constexpr std::size_t W_U8_length =
        chord_datatype_bytes(W_U8_type) * 2 * 16 * 16 * 2 * 512;
    ...
    static constexpr std::size_t Ebar_U8_length =
        chord_datatype_bytes(Ebar_U8_type) * 256 * 2 * 512 * 4096;
    ...
    static constexpr std::size_t I_U8_length =
        chord_datatype_bytes(I_U8_type) * 32 * 32 * 512 * 512;
    ...
    static constexpr std::array<std::ptrdiff_t, I_U8_rank + 1> I_U8_strides = {
        ...
        I_U8_calc_stride(I_U8_index_Fbar_U8), I_U8_calc_stride(I_U8_index_Ttilde_U8_Tds25),
    ...
    static constexpr std::size_t info_length = chord_datatype_bytes(info_type) * 32 * 16 * 512;
    ...
    static constexpr std::size_t I_U8_Ttilde_U8_Tds25_sample_bytes =
...
int cudaFRBBeamformer_hirax_U8::wait_on_precondition() {
    ...
    // to bytes
    const std::size_t output_bytes = Ttildelength * I_U8_Ttilde_U8_Tds25_sample_bytes;
    ...
    assert(mod(output_cursor, I_U8_Ttilde_U8_Tds25_sample_bytes) == 0);
    Ttildemin = output_cursor / I_U8_Ttilde_U8_Tds25_sample_bytes;
...
cudaEvent_t cudaFRBBeamformer_hirax_U8::execute(cudaPipelineState& /*pipestate*/,
    ...
    *I_U8_meta = *Ebar_U8_meta;
    ...
    const std::size_t Ttilde_ringbuf =
        output_ringbuf_signal->size / I_U8_Ttilde_U8_Tds25_sample_bytes;
    ...
    // Update metadata
    I_U8_meta->dim[I_U8_rank - 1 - I_U8_index_Ttilde_U8_Tds25] = Ttildelength;
    assert(I_U8_meta->dim[I_U8_rank - 1 - I_U8_index_Ttilde_U8_Tds25]
           <= int(I_U8_lengths[I_U8_index_Ttilde_U8_Tds25]));
...
void cudaFRBBeamformer_hirax_U8::finalize_frame() {
    ...
    DEBUG("    Produced bytes:   {:d}", Ttilde_produced * I_U8_Ttilde_U8_Tds25_sample_bytes);
    output_ringbuf_signal->finish_write(unique_name, instance_num,
                                        Ttilde_produced * I_U8_Ttilde_U8_Tds25_sample_bytes);
