@fastmath @inbounds(
    begin #= /home/eschnett/src/kotekan/julia/kernels/xpose2048.jl:347 =#
        ...
        scatter_indices_register0 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (0::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register1 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (1::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register2 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (2::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register3 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (3::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register4 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (4::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register5 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (5::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register6 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (6::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register7 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (7::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register8 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (8::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register9 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (9::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register10 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (10::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register11 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (11::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register12 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (12::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register13 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (13::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register14 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (14::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register15 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (15::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register16 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (16::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register17 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (17::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register18 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (18::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register19 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (19::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register20 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (20::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register21 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (21::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register22 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (22::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register23 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (23::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register24 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (24::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register25 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (25::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register26 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (26::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register27 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (27::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register28 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (28::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register29 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (29::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register30 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (30::Int32 % 32) * 4) % 1024) + 0x01]
        scatter_indices_register31 = scatter_indices_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2) % 2) * 1024 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 128 + (31::Int32 % 32) * 4) % 1024) + 0x01]
