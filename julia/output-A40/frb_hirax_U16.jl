    ...
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1861 =#
        ...
        if !(
            0i32 ≤ Tmin < 2048 && (
                Tmin ≤ Tmax < 4096 && (
                    (Tmax - Tmin) % 64 == 0i32 &&
                    (0i32 ≤ T̄min < 256 && (T̄min ≤ T̄max < 512 && T̄max - T̄min == (Tmax - Tmin) ÷ 25))
                )
            )
        )
            info = 2
        ...
        if !(
            0i32 ≤ Fmin ≤ Fmax ≤ 1024 && (
                (Fmax - Fmin) % 16 == 0i32 &&
                (0i32 ≤ F̄min ≤ F̄max ≤ 1024 && ((F̄max - F̄min) % 16 == 0i32 && F̄max - F̄min == Fmax - Fmin))
            )
        )
            info = 3
            if true
        ...
        if let
            ...
            W_polr0 = W_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 64 + 0 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512) + 0x01]
            W_polr1 = W_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 64 + 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:64:2047
            ...
            let
                ...
                if true
                    Fsh1_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) ÷ 8) % 32) * 257 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    Fsh1_shared[(((((((4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) ÷ 8) % 32) * 257 + ((((4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                ...
                if true
                    Fsh1_shared[(((((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) ÷ 8) % 32) * 257 + ((((1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16) + 2) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32) + 0) + 0x01] =
                        E_dish8_time32
                end
                if true
                            ...
                            if (t_inner_hi + t + 1i32) % 1 == 0i32
                                if t_running == 25
                                    if let
                                        ...
                                        if true
                                            I_memory[let
                                                offset = 524288 * T̄min + 512 * F̄min
                                                length = 134217728
                                                mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 2) % 16 + ((IndexSpaces.assume_inrange(dstime, 0, 1, 256) % 256) % 256) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) % 32) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512) + 0) + offset, length)
                                            end + 0x01] = I
                                        end
                                    end
                                    I = zero(Float16x2)
