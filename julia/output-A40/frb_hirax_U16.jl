...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1784 =#
        ...
        if let
            ...
            W_polr0 = W_memory[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16 + 0) + 0x01]
            W_polr1 = W_memory[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 64 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16 + 256) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:64:2047
            ...
            let
                ...
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    Fsh1_shared[((((16 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish0_time16
                end
                if true
                    Fsh1_shared[((((16 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 4) ÷ 8) % 32) * 257) + 0) + 0x01] =
                ...
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish0_time32
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) + 4) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) + 4) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish4_time32
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish8_time32
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) + 4) % 8) * 32 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) + 4) ÷ 8) % 32) * 257) + 0) + 0x01] =
                        E_dish12_time32
                end
                if true
                    Fsh1_shared[((((16 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 8) + 1) ÷ 8) % 32) * 257) + 0) + 0x01] =
            ...
            let
                Freg1_dish0 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish16 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish32 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish48 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish64 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish80 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((80 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((80 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish96 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((96 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish112 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((112 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((112 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish128 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((128 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((128 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish144 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((144 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish160 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((160 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((160 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish176 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((176 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((176 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish192 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((192 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish208 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((208 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((208 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish224 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((224 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((224 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                Freg1_dish240 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32 + ((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64) % 32 + ((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) % 8) * 32 + (((240 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) ÷ 8) % 32) * 257) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_time0 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + (((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time2 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time4 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time6 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 6) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time8 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time10 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 10) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time12 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 12) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time14 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 14) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time16 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time18 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 18) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time20 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 20) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time22 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 22) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time24 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time26 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 26) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                    Freg2_time28 = Fsh2_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(t_outer, 0, 64, 2048) ÷ 64) % 32) * 64 + 28) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) ÷ 8) % 2) % 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 16) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 4) * 546) + 0x01]
                                    ...
                                    if let
                                        ...
                                        if true
                                            I_memory[let
                                                offset = 524288 * T̄min
                                                length = 134217728
                                                mod(((((IndexSpaces.assume_inrange(dstime, 0, 1, 256) % 256) % 256) * 524288 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 16) % 16) * 2) % 32) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1024) % 1024) % 1024) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 2) % 16) + 0) + offset, length)
                                            end + 0x01] = I
                                        end
                                    end
                                    I = zero(Float16x2)
