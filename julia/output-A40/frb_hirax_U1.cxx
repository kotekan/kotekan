...
private:
    ...
    static constexpr std::size_t W1_length = chord_datatype_bytes(W1_type) * 2 * 16 * 16 * 2 * 64;
    ...
    static constexpr std::size_t Ebar1_length =
        chord_datatype_bytes(Ebar1_type) * 256 * 2 * 64 * 32768;
    ...
    static constexpr std::size_t I1_length = chord_datatype_bytes(I1_type) * 32 * 32 * 64 * 4096;
