@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:743 =#
    ...
    s_polr0 = s_memory[((((IndexSpaces.assume_inrange(
        ...
        0,
        2048,
    )÷16)%128)%128)*32+0+((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_threadidx(),
        0,
        32,
    )÷8)%4+(IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4)%4)*4)%16)+0x01]
    s_polr1 = s_memory[((((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_blockidx(),
        0,
        2048,
    )÷16)%128)%128)*32+16+((IndexSpaces.assume_inrange(
        IndexSpaces.cuda_threadidx(),
        0,
        32,
    )÷8)%4+(IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4)%4)*4)%16)+0x01]
        ...
        for T2 = 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                ...
                E_shared[((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish0_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                )÷2)%2)%2)*544+((4+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )%4)*16)÷4)%16+(((((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish4_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish8_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                )÷2)%2)%2)*544+((12+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                )%4)*16)÷4)%16+(((((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    4,
                )%2)*16)+8)+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_blockidx(),
                    0,
                    2048,
                )%16)*2048)+(IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish0_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish4_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish8_time8
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    4,
                    ...
                    0,
                    32,
                )÷4)%8)%32)*17)+0+0x01] = E_dish12_time8
            end
                ...
                let
                    ...
                    let
                        ...
                        E0 = E_shared[((((IndexSpaces.assume_inrange(
                            ...
                            0,
                            4,
                        )÷2)%2)%2)*544+((((D÷4)%4)*4+(IndexSpaces.assume_inrange(
                            IndexSpaces.cuda_threadidx(),
                            0,
                            32,
                        )%4)*16)÷4)%16+(((((((IndexSpaces.assume_inrange(
            ...
            Ju_polr0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                4,
            )%4)*4)%16+0+((((((IndexSpaces.assume_inrange(
                T1,
                0,
                128,
                2048,
            ...
            Ju_polr1_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                4,
            )%4)*4)%16+640+((((((IndexSpaces.assume_inrange(
                T1,
                0,
                128,
                2048,
