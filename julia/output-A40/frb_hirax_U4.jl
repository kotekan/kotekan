...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1870 =#
        ...
        if let
            ...
            W_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4) * 16 + ((0::Int32 % 2) % 2) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 4) % 4) % 4) * 512) + 0x01]
            W_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4) * 16 + ((1::Int32 % 2) % 2) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 4) % 4) % 4) * 512) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:64:16383
            ...
            let
                ...
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((0::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish0_time0
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((0::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish4_time0
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((0::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish8_time0
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (0::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((0::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish12_time0
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((16::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish0_time16
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((16::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish4_time16
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((16::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish8_time16
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (16::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((16::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish12_time16
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((32::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish0_time32
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((32::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish4_time32
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((32::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish8_time32
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (32::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((32::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish12_time32
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((0::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((48::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish0_time48
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((4::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((48::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish4_time48
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((8::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((8::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((48::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish8_time48
                Fsh1_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((12::Int32 ÷ 8) % 2) * 2 + (48::Int32 ÷ 32) % 2 + ((12::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) ÷ 8) % 32) * 257 + (((48::Int32 ÷ 16) % 2) * 16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0) + 0x01] =
                    E_dish12_time48
            ...
            let
                ...
                if let
                    ...
                    Freg2_time0 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 16) * 33 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 2184 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 4) * 546 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((0::Int32 ÷ 2) % 16) * 2 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 32) + 0x01]
                ...
                let t_inner_hi = 0
                    for t_inner_lo in 0:8:31
                        ...
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((0::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr0_time0
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((0::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr0_time0
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((0::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr1_time0
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((0::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr1_time0
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((2::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr0_time2
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((2::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr0_time2
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((2::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr1_time2
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((2::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr1_time2
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((4::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr0_time4
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((4::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr0_time4
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((4::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr1_time4
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((4::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr1_time4
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((6::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr0_time6
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((6::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx1_polr0_time6
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((6::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 0::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                            G_cplx0_polr1_time6
                        Gsh_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) ÷ 8) % 2 + ((IndexSpaces.assume_inrange(t_inner_hi::Int32, 0, 32, 64) ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64 + ((6::Int32 ÷ 2) % 4) * 2) % 8) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2 + 1::Int32 % 2) % 2) * 4144) + 0) + 0x01] =
                        ...
                        let t = 0
                            ...
                            if true
                                G_polr0 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 8) % 2) * 516 + ((0::Int32 % 2) % 2) * 16 + ((t::Int32 % 8 + ((t_inner_hi::Int32 ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 2) * 4144) + 0x01]
                                G_polr1 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 8) % 2) * 516 + ((1::Int32 % 2) % 2) * 16 + ((t::Int32 % 8 + ((t_inner_hi::Int32 ÷ 32) % 2) * 32 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 16384) ÷ 64) % 256) * 64) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 16) % 2) * 258 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 4) % 2) * 1032 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 2) % 2) * 2064 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 2) * 4144) + 0x01]
                            end
                            X_polr0 = G_polr0
                            X_polr1 = G_polr1
                                    ...
                                    if 0i32 ≤
                                       ...
                                       32
                                        I_memory[let
                                            ...
                                            length = 1073741824
                                            mod(((((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 1024) % 1024) % 1024) * 1048576 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 2) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 32) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 4) % 4) % 2048) * 512) + 0) + offset, length)
                                        end + 0x01] = I
                                    end
                                    I = zero(Float16x2)
                                    t_running = 0
