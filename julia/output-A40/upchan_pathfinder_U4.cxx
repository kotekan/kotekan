...
private:
    ...
    static constexpr std::ptrdiff_t G_length = chord_datatype_bytes(G_type) * 512;
    ...
    static constexpr std::ptrdiff_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 64 * 2 * 512 * 16384;
    ...
    static constexpr std::ptrdiff_t info_length = chord_datatype_bytes(info_type) * 32 * 4 * 128;
