...
private:
    ...
    static constexpr std::ptrdiff_t W_length =
        chord_datatype_bytes(W_type) * 2 * 16 * 16 * 2 * 4096;
    ...
    static constexpr std::ptrdiff_t I_length = chord_datatype_bytes(I_type) * 32 * 32 * 4096 * 64;
    ...
    static constexpr std::ptrdiff_t info_length = chord_datatype_bytes(info_type) * 32 * 16 * 4096;
