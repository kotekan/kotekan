...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 8 * 12 * 2 * 12288;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 16 * 24 * 12288 * 128;
