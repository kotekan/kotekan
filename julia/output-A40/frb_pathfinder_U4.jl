...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1784 =#
        info = 1
        if true
            info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 6) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192) + 0) + 0x01] =
                info
        end
        if !(
        ...
        if let
            ...
            W_dishM0_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + 0) + 0x01]
            W_dishM4_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + 0) + 0x01]
            W_dishM0_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + 96) + 0x01]
            W_dishM4_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + 96) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:48:8159
            ...
            let
                ...
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 4) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 4) ÷ 8) % 8) * 260) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) % 8) * 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) ÷ 8) % 8) * 260) + 0) + 0x01] =
                        E_dish0_time24
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) + 4) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) + 4) ÷ 8) % 8) * 260) + 0) + 0x01] =
                        E_dish4_time24
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) % 8) * 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) ÷ 8) % 8) * 260) + 0) + 0x01] =
                        E_dish8_time24
                end
                if true
                    Fsh1_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) + 4) % 8) * 32 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 8) + 1) + 4) ÷ 8) % 8) * 260) + 0) + 0x01] =
                        E_dish12_time24
                end
                IndexSpaces.cuda_sync_threads()
            end
            let
                Freg1_dish0 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish6 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 6) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish12 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 12) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 12) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish18 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 18) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 18) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish24 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 24) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 24) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish30 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 30) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 30) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish36 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 36) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 36) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish42 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 42) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 42) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish48 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 48) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 48) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish54 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 54) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 54) ÷ 8) % 8) * 260) + 0x01]
                Freg1_dish60 = Fsh1_shared[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 60) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6 + 60) ÷ 8) % 8) * 260) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                let
                    ...
                    for t_inner_lo in 0:6:23
                        ...
                        if true
                            Gsh_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 16) % 2) * 98 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 2) % 2) * 784 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 4) % 2) * 392 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) % 8 + ((((((IndexSpaces.assume_inrange(t_inner_hi, 0, 24, 48) ÷ 24) % 2) * 24 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) + ((IndexSpaces.assume_inrange(t_inner_lo, 0, 6, 24) ÷ 6) % 4) * 6) % 6) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 8) % 2) * 196 + 8) + 0) + 0x01] =
                                G_cplx0_dishM0_polr1_time0
                        end
                        if true
                            Gsh_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2 + 1) ÷ 16) % 2) * 98 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2 + 1) ÷ 2) % 2) * 784 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2 + 1) ÷ 4) % 2) * 392 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) % 8 + ((((((IndexSpaces.assume_inrange(t_inner_hi, 0, 24, 48) ÷ 24) % 2) * 24 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) + ((IndexSpaces.assume_inrange(t_inner_lo, 0, 6, 24) ÷ 6) % 4) * 6) % 6) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2 + 1) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2 + 1) ÷ 8) % 2) * 196 + 8) + 0) + 0x01] =
                        ...
                        if true
                            Gsh_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 16) % 2) * 98 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 2) % 2) * 784 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 4) % 2) * 392 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) % 8 + (((((3 + ((IndexSpaces.assume_inrange(t_inner_hi, 0, 24, 48) ÷ 24) % 2) * 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) + ((IndexSpaces.assume_inrange(t_inner_lo, 0, 6, 24) ÷ 6) % 4) * 6) % 6) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 16) * 2) ÷ 8) % 2) * 196 + 0) + 0) + 0x01] =
                                    ...
                                    if let
                                        ...
                                        if true
                                            I_memory[let
                                                offset = 294912 * T̄min
                                                length = 301989888
                                                mod(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 1536) % 1536) % 1536) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4) % 24) * 8 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 2) ÷ 2) % 8 + ((IndexSpaces.assume_inrange(dstime, 0, 1, 1024) % 1024) % 1024) * 294912) + 0) + offset, length)
                                            end + 0x01] = I
                                        end
                                    end
                                    I = zero(Float16x2)
