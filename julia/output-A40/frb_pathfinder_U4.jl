...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1891 =#
        ...
        if !(
            0i32 ≤ Fmin ≤ Fmax ≤ 512 && (
                (Fmax - Fmin) % 4 == 0i32 &&
                (0i32 ≤ F̄min ≤ F̄max ≤ 4096 && ((F̄max - F̄min) % 4 == 0i32 && F̄max - F̄min == Fmax - Fmin))
            )
        )
            info = 3
            if true
        ...
        for t_outer in 0:48:8159
            ...
            let
                Freg1_dish0 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish6 = Fsh1_shared[(((6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish12 = Fsh1_shared[(((12 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((12 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish18 = Fsh1_shared[(((18 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((18 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish30 = Fsh1_shared[(((30 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((30 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish36 = Fsh1_shared[(((36 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((36 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish42 = Fsh1_shared[(((42 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((42 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish54 = Fsh1_shared[(((54 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((54 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish60 = Fsh1_shared[(((60 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((60 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time3 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time3 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time6 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time6 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time9 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((9 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time9 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((9 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time12 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time12 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time15 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((15 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time15 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((15 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time18 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((18 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time18 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((18 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time21 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((21 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time21 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((21 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 8160) ÷ 48) % 170) * 48) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                end
                IndexSpaces.cuda_sync_threads()
                let
                    t_inner_hi = 0
