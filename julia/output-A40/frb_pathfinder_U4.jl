...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1882 =#
        ...
        for t_outer in 0:48:8159
            ...
            let
                Freg1_dish0 = Fsh1_shared[((((((0::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((0::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish6 = Fsh1_shared[((((((6::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((6::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish12 = Fsh1_shared[((((((12::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((12::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish18 = Fsh1_shared[((((((18::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((18::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[((((((24::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((24::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish30 = Fsh1_shared[((((((30::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((30::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish36 = Fsh1_shared[((((((36::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((36::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish42 = Fsh1_shared[((((((42::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((42::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[((((((48::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((48::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish54 = Fsh1_shared[((((((54::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((54::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                Freg1_dish60 = Fsh1_shared[((((((60::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) ÷ 8) % 8) * 260 + ((((60::Int32 ÷ 6) % 11) * 6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 6) % 8) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time0 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((0::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time3 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((3::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time6 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((6::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time12 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((12::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time15 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((15::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    Freg2_dishM4_time15 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((4::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((15::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
                    ...
                    Freg2_dishM0_time21 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 33 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((21::Int32 ÷ 3) % 8) * 3) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 8160) ÷ 48) % 170) * 48) % 24) + 0x01]
