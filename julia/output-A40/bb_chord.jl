        ...
        for T2 = 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                ...
                E_shared[((((IndexSpaces.assume_inrange(
                    ...
                    0,
                    32,
                )%8)*16)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish0_time0
                E_shared[((((4+(IndexSpaces.assume_inrange(
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish4_time0
                E_shared[((((8+(IndexSpaces.assume_inrange(
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish8_time0
                E_shared[((((12+(IndexSpaces.assume_inrange(
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish0_time16
                E_shared[((((4+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish4_time16
                E_shared[((((8+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish8_time16
                E_shared[((((12+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                    ...
                    0,
                    512,
                )%16)*2048)%32)*129)+0+0x01] = E_dish12_time16
            end
            ...
            for T3 = 0:8:31
                let
                    ...
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        ...
                        0,
                        24,
                    )÷4)%6)*16)+((B÷8)%2)*8)%96+(((((((IndexSpaces.assume_inrange(
                        T1,
                        0,
                        128,
                        2048,
                    ...
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        ...
                        32,
                        128,
                    )÷32)%4)*32)+1)+((IndexSpaces.assume_inrange(
                        T3,
                        0,
                        8,
                        32,
