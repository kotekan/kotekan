...
private:
    ...
    static constexpr std::size_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 512 * 2 * 1024 * 512;
...
cudaUpchannelizer_U64::cudaUpchannelizer_U64(Config& config, const std::string& unique_name,
    ...
    cudaCommand(config, unique_name, host_buffers, device, instance_num, no_cuda_command_state,
                "Upchannelizer_U64", "Upchannelizer_U64.ptx"),
    ...
    device.build_ptx("Upchannelizer_U64.ptx", {kernel_symbol}, opts);
...
void cudaUpchannelizer_U64::finalize_frame() {
