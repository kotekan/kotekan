...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1881 =#
        ...
        if let
            ...
            W_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 1024) % 1024) % 1024) * 512 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64 + ((0::Int32 % 2) % 2) * 256 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4) * 16) + 0x01]
            W_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 1024) % 1024) % 1024) * 512 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64 + ((1::Int32 % 2) % 2) * 256 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4) * 16) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:64:2047
            ...
            let
                ...
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish0_time0
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish4_time0
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish8_time0
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (0::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish12_time0
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish0_time16
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish4_time16
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish8_time16
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (16::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish12_time16
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish0_time32
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish4_time32
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish8_time32
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (32::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish12_time32
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 8) % 2) * 2 + ((0::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish0_time48
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 8) % 2) * 2 + ((4::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish4_time48
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 8) % 2) * 2 + ((8::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish8_time48
                Fsh1_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) ÷ 8) % 32) * 257 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 2048) ÷ 64) % 32) * 64 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 8) % 2) * 2 + ((12::Int32 ÷ 4) % 2) * 4 + (48::Int32 ÷ 32) % 2) % 8) * 32) + 0) + 0x01] =
                    E_dish12_time48
