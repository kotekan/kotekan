...
Download the `DPDK version 16.11.4 from <http://fast.dpdk.org/rel/dpdk-16.11.4.tar.xz>`_
...
.. code:: bash
    ...
    /opt/dpdk-stable-16.11.4/tools/dpdk-devbind.py --bind uio_pci_generic $PCI_NIC_LIST
