...
// Output must be 4 bytes aligned.
static inline void
rte_mov16_nt(uint8_t *dst, const uint8_t *src)
{
    __m128i xmm0;
...
static inline void
rte_mov32_nt(uint8_t *dst, const uint8_t *src)
{
    __m256i ymm0;
...
// Output must be 4 byte aligned.
static inline void
rte_mov64blocks_nt(uint8_t *dst, const uint8_t *src, size_t n)
{
    __m256i ymm0, ymm1;
...
static inline void
rte_mov256blocks_nt(uint8_t *dst, const uint8_t *src, size_t n)
{
