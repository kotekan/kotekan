...
public:
     ...
     */
    template<class T>
    void add_process_metric(const string& name, const string& process_name, const T& value,
                            const string& labels = "") {
        ...
        ((processMetric<T>*)process_metrics[key])->last_update_time_stamp =
     ...
     */
    void remove_metric(const string& name, const string& process_name, const string& labels = "");
