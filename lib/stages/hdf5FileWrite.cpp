...
public:
    ...
    void write_n2(const std::string& full_path, const N2FrameView& frame) {
        ...
        file.createAttribute("frame_eop.t_inst", frame.frame_eop.t_inst);
        file.createAttribute("frame_eop.t_ut1", frame.frame_eop.t_ut1);
        file.createAttribute("frame_eop.delta_UT1_inst", frame.frame_eop.delta_UT1_inst);
        file.createAttribute("frame_eop.ERA_deg", frame.frame_eop.ERA_deg);
        file.createAttribute("frame_eop.xp_as", frame.frame_eop.xp_as);
        file.createAttribute("frame_eop.yp_as", frame.frame_eop.yp_as);
