...
#include <stdint.h>             // for uint64_t, uint32_t, uint8_t, int8_t, int16_t, int32_t
...
#include "chordMetadata.hpp"    // for chordMetadata, chordDataType, get_chord_metadata, int4p4
