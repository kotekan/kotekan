...
parseReorderDefault::parseReorderDefault(Config& config, const std::string& unique_name,
    ...
    _input_order(config.get_default<ElementOrder>(unique_name, "input_order", ElementOrder::CHIMECorrelator)),
    _output_order(config.get_default<ElementOrder>(unique_name, "output_order", ElementOrder::CHIMECylinder)),
