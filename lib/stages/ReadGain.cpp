...
bool ReadGain::update_gains_psr_callback(nlohmann::json& json) {
    ...
    try {
        ...
        INFO("[PSR] Updating gains from {:s} {:s} {:s} {:s} {:s} {:s} {:s} {:s} {:s} {:s}",
             _gain_dir_psr[0], _gain_dir_psr[1], _gain_dir_psr[2], _gain_dir_psr[3],
             _gain_dir_psr[4], _gain_dir_psr[5], _gain_dir_psr[6], _gain_dir_psr[7],
             _gain_dir_psr[8], _gain_dir_psr[9]);
