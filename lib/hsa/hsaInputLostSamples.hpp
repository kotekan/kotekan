 ...
 * Currently, only the RFI pipeline commands use the lost samples information to avoid marking zeroed 
 * data as interference.
 *
 * @par GPU Memory
 * @gpu_mem  lost_samples     Array indicating if a given timestep was zeroed, size: samples_per_data_set
