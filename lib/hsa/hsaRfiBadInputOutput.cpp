...
hsaRfiBadInputOutput::hsaRfiBadInputOutput(Config& config, const string &unique_name,
    ...
    hsaCommand(config, unique_name,
                                 host_buffers, device,
                                "hsaRfiBadInputOutput",""){
...
hsa_signal_t hsaRfiBadInputOutput::execute(int gpu_frame_id,
    ...
    //Get GPU memory
    void * gpu_output_ptr = device.get_gpu_memory_array("rfi_bad_input",
                                                        gpu_frame_id,
                                                        _rfi_output_buf->frame_size);
...
void hsaRfiBadInputOutput::finalize_frame(int frame_id) {
    ...
    // since the hsaInputData command does that.
