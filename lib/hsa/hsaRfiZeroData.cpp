...
hsa_signal_t hsaRfiZeroData::execute(int gpu_frame_id, hsa_signal_t precede_signal) {
    ...
    args.input = device.get_gpu_memory_array("input", gpu_frame_id, _gpu_buffer_depth, input_frame_len);
    args.mask = device.get_gpu_memory_array("rfi_mask_output", gpu_frame_id, _gpu_buffer_depth, mask_len);
