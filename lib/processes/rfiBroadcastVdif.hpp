/**
 * @file rfiBroadcastVdif.hpp
 * @brief Contains RFI data broadcaster for VDIF data in kotekan.
 *  - rfiBroadcastVdif : public KotekanProcess
 */
...
/**
 * @class rfiBroadcastVdif
 * @brief Consumer ``KotekanProcess`` which consumer a buffer filled with output from the kurtosis estimator
 *
 * This process reads RFI data from a kotekan buffer before packaging it ito UDP packets and sending them
 ...
 *
 * @par Buffers
 * @buffer rfi_in	The kotekan buffer containing kurtosi estimates of a VDIF style input which 
