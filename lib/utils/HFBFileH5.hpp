...
- HFBFile_H5Fast
*****************************************/
#ifndef HFB_FILE_H5_HPP
#define HFB_FILE_H5_HPP
 ...
 * @author Richard Shaw
 **/
class HFBFileH5 : public visFile {
...
public:
     ...
     **/
    HFBFileH5(const std::string& name, const kotekan::logLevel log_level,
...
protected:
    ...
    // sharing of code between HFBFileH5 and subclasses
 ...
 * @author Richard Shaw
 **/
class HFBFileH5Fast : public HFBFileH5 {
...
public:
     ...
     * @param max_time  Maximum number of times to write into the file.
     **/
    HFBFileH5Fast(const std::string& name, const kotekan::logLevel log_level,
                  const std::map<std::string, std::string>& metadata, dset_id_t dataset,
                  size_t max_time);
...
protected:
    ...
    off_t hfb_offset, weight_offset, gcoeff_offset, gexp_offset, eval_offset, evec_offset,
