 ...
 *
 **/
class Telescope : kotekan::kotekanLogging {
...
public:
    ...
    /**
     * Get the physical frequency in MHz of the specified stream ID.
     *
     * The baseclass implementation just calls
     * `to_freq(to_freq_id(stream))`, override with a custom implementation
     ...
     **/
    virtual timespec seq_length() const = 0;
