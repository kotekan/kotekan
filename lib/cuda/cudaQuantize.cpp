...
cudaEvent_t cudaQuantize::execute(cudaPipelineState& pipestate,
    ...
    void* input_memory =
        device.get_gpu_memory_array(_gpu_mem_input, pipestate.gpu_frame_id, _gpu_buffer_depth, input_frame_len);
    ...
    void* meanstd_memory =
        device.get_gpu_memory_array(_gpu_mem_meanstd, pipestate.gpu_frame_id, _gpu_buffer_depth, meanstd_frame_len);
