...
void cpu_quantize8chime(const float* input, float16_t* outputf, std::uint8_t* outputi,
                        ...
                        int outputf_stride2, int outputf_stride3, int outputi_size1,
                        int outputi_size2, int outputi_size3, int outputi_stride2,
                        int outputi_stride3);
...
void gpu_quantize8chime(const float* input, float16_t* outputf, std::uint8_t* outputi,
                        ...
                        int outputf_stride2, int outputf_stride3, int outputi_size1,
                        int outputi_size2, int outputi_size3, int outputi_stride2,
                        int outputi_stride3, cudaStream_t stream);
