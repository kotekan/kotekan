...
private:
    ...
    static constexpr std::ptrdiff_t G_U64_length = type_total_bytes(G_U64_type) * 256;
    ...
    static constexpr std::ptrdiff_t Ebar_length = type_total_bytes(Ebar_type) * 512 * 2 * 256 * 512;
