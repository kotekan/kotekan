...
private:
    ...
    static constexpr std::size_t W_U128_length =
        chord_datatype_bytes(W_U128_type) * 2 * 16 * 16 * 2 * 8192;
    ...
    static constexpr std::size_t Ebar_U128_length =
        chord_datatype_bytes(Ebar_U128_type) * 256 * 2 * 8192 * 256;
    ...
    enum I_U128_indices {
        ...
        I_U128_index_Ttilde_U128_Tds25,
        I_U128_rank,
    };
    ...
    static constexpr std::size_t I_U128_length =
        chord_datatype_bytes(I_U128_type) * 32 * 32 * 8192 * 32;
    ...
    static constexpr std::array<std::ptrdiff_t, I_U128_rank + 1> I_U128_strides = {
        ...
        I_U128_calc_stride(I_U128_index_Ttilde_U128_Tds25),
    ...
    static constexpr std::size_t I_U128_Ttilde_U128_Tds25_sample_bytes =
...
int cudaFRBBeamformer_hirax_U128::wait_on_precondition() {
    ...
    // to bytes
    const std::size_t output_bytes = Ttildelength * I_U128_Ttilde_U128_Tds25_sample_bytes;
    ...
    assert(mod(output_cursor, I_U128_Ttilde_U128_Tds25_sample_bytes) == 0);
    Ttildemin = output_cursor / I_U128_Ttilde_U128_Tds25_sample_bytes;
...
cudaEvent_t cudaFRBBeamformer_hirax_U128::execute(cudaPipelineState& /*pipestate*/,
    ...
    *I_U128_meta = *Ebar_U128_meta;
    ...
    const std::size_t Ttilde_ringbuf =
        output_ringbuf_signal->size / I_U128_Ttilde_U128_Tds25_sample_bytes;
    ...
    // Update metadata
    I_U128_meta->dim[I_U128_rank - 1 - I_U128_index_Ttilde_U128_Tds25] = Ttildelength;
    assert(I_U128_meta->dim[I_U128_rank - 1 - I_U128_index_Ttilde_U128_Tds25]
           <= int(I_U128_lengths[I_U128_index_Ttilde_U128_Tds25]));
...
void cudaFRBBeamformer_hirax_U128::finalize_frame() {
    ...
    DEBUG("    Produced bytes:   {:d}", Ttilde_produced * I_U128_Ttilde_U128_Tds25_sample_bytes);
    output_ringbuf_signal->finish_write(unique_name, instance_num,
                                        Ttilde_produced * I_U128_Ttilde_U128_Tds25_sample_bytes);
