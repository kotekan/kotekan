...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 24 * 24 * 2 * 512;
    ...
    static constexpr std::size_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 512 * 2 * 512 * 4096;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 48 * 48 * 512 * 128;
