...
#warning "TODO"
    // if (!(meta->offset_downsampling == 1)) {
    //     DEBUG("cudaCopyFromRingbuffer::execute {:s}, offset_downsampling={:d}",
    //           signal_buffer->buffer_name, meta->offset_downsampling);
    // }
    // assert(meta->offset_downsampling == 1);
