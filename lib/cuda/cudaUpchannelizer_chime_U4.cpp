...
private:
    ...
    static constexpr std::ptrdiff_t G_U4_length = type_total_bytes(G_U4_type) * 4;
    ...
    static constexpr std::ptrdiff_t Ebar_length =
        type_total_bytes(Ebar_type) * 1024 * 2 * 4 * 16384;
    ...
    static constexpr std::ptrdiff_t info_length = type_total_bytes(info_type) * 32 * 4 * 256;
