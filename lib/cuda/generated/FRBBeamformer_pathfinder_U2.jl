...
@fastmath @inbounds(
    begin #= /home/eschnett/src/kotekan/julia/kernels/frb.jl:1874 =#
        ...
        if let
            ...
            W_dishM0_polr0 = W_memory[(((0::Int32 % 2) % 2) * 96 + (((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) % 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 192) + 0x01]
            W_dishM4_polr0 = W_memory[(((0::Int32 % 2) % 2) * 96 + (((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) % 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 192) + 0x01]
            W_dishM0_polr1 = W_memory[(((1::Int32 % 2) % 2) * 96 + (((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) % 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 192) + 0x01]
            W_dishM4_polr1 = W_memory[(((1::Int32 % 2) % 2) * 96 + (((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2) % 8 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 256) % 256) % 256) * 192) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:48:16367
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time0 = Fsh2_shared[((((0::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time0 = Fsh2_shared[((((0::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time3 = Fsh2_shared[((((3::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time3 = Fsh2_shared[((((3::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time6 = Fsh2_shared[((((6::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time6 = Fsh2_shared[((((6::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time9 = Fsh2_shared[((((9::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time9 = Fsh2_shared[((((9::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time12 = Fsh2_shared[((((12::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time12 = Fsh2_shared[((((12::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time15 = Fsh2_shared[((((15::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time15 = Fsh2_shared[((((15::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time18 = Fsh2_shared[((((18::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time18 = Fsh2_shared[((((18::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time21 = Fsh2_shared[((((21::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((0::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time21 = Fsh2_shared[((((21::Int32 ÷ 3) % 8) * 3 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) ÷ 2) % 3 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48) % 24 + ((((4::Int32 ÷ 4) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 870) + 0x01]
                end
                IndexSpaces.cuda_sync_threads()
                let t_inner_hi = 0
