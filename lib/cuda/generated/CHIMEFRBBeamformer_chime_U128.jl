    ...
    begin #= /home/gryan/Science/chord/code/kotekan/julia/kernels/chimefrb.jl:1335 =#
        ...
        if !(
            0i32 ≤ Tbarmin < 512 && (
                Tbarmin ≤ Tbarmax < 1024 && (
                    (Tbarmax - Tbarmin) % 512 == 0i32 &&
                    (0i32 ≤ Ttildemin < 4 && (Ttildemin ≤ Ttildemax < 8 && Ttildemax - Ttildemin == (Tbarmax - Tbarmin) ÷ 512))
                )
            )
        )
            info = 2
        ...
        for time_outer in 0:512:2047
            ...
            for time_inner in 0:1:511
                ...
                I_beamQ0 = muladd(
                    Float16x2(0.00024414062f0, 0.00024414062f0),
                    muladd(
                        Y_polr1_im_beamQ0,
                        Y_polr1_im_beamQ0,
                        muladd(
