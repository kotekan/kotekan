...
@fastmath @inbounds(
    begin #= /home/rhaas/CHIME/kotekan/julia/kernels/chimefrb.jl:1339 =#
        ...
        W_dish0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 0::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 1::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish2 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 2::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish3 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 3::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish4 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 4::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish5 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 5::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish6 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 6::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        W_dish7 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 2048) % 2048) % 2048) * 2048 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 1024 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 2) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 2) % 2) * 64 + 7::Int32 % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) * 32) % 1024) + 0x01]
        for time_outer in 0:3:767
            ...
            for time_inner in 0:1:2
                ...
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((0::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((0::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP0_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((2::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((2::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP2_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((4::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((4::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP4_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((6::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((6::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP6_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((8::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((8::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP8_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((10::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((10::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP10_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((12::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((12::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP12_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((14::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((14::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP14_cplx0
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((0::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((0::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP0_cplx1
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((2::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((2::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                    Y_beamP2_cplx1
                Y_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) ÷ 4) % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 4) * 256) ÷ 256) % 4) * 512 + ((((4::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + (((((4::Int32 ÷ 2) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0) + 0x01] =
                ...
                X_cplx0_dish0_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish0_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish256_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((256::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish256_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((256::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish512_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((512::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish512_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((512::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish768_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((768::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish768_polr0 = Y_shared[(((0::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((768::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish0_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish0_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((0::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish256_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((256::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish256_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((256::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish512_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((512::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish512_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((512::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx0_dish768_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((0::Int32 % 2) % 2) * 32 + (((((768::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
                X_cplx1_dish768_polr1 = Y_shared[(((1::Int32 % 2) % 2) * 2048 + ((1::Int32 % 2) % 2) * 32 + (((((768::Int32 ÷ 256) % 4) * 256) ÷ 256) % 4) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 16) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 8) % 8) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 16) ÷ 2) % 8) * 64) + 0x01]
