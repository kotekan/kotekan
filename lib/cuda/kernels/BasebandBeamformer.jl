@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:809 =#
    ...
    s = s_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 16) % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 32) % 16) % 16) * 192) + 0x01]
    s = s - 3
    if !(0i32 < s < 32i32)
        info = 2
        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 512) % 512) * 768 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32) + 0 + 0x01] = info
    ...
    (A_beam0_cplx0_dish0, A_beam0_cplx1_dish0, A_beam0_cplx0_dish4, A_beam0_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                           (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                            ...
                                                                                                                            49152) +
                                                                                                                           1i32)
    (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0, A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                           ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                            0,
                                                                                                                                                            24) ÷
                                                                                                                                 4) %
                                                                                                                            ...
                                                                                                                            49152) +
                                                                                                                           1i32)
    (A_beam0_cplx0_dish8, A_beam0_cplx1_dish8, A_beam0_cplx0_dish12, A_beam0_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                             (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                             0,
                                                                                                                                                             24) ÷
                                                                                                                                  4) %
                                                                                                                              ...
                                                                                                                              49152) +
                                                                                                                             1i32)
    (A_beam8_cplx0_dish8, A_beam8_cplx1_dish8, A_beam8_cplx0_dish12, A_beam8_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                             ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                              0,
                                                                                                                                                              24) ÷
                                                                                                                                   4) %
                                                                                                                              ...
                                                                                                                              49152) +
                                                                                                                             1i32)
    (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16, A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                               ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                                0,
                                                                                                                                                                24) ÷
                                                                                                                                     4) %
                                                                                                                                ...
                                                                                                                                49152) +
                                                                                                                               1i32)
    (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16, A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                               (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                                 0,
                                                                                                                                                                 24) ÷
                                                                                                                                      4) %
                                                                                                                                ...
                                                                                                                                49152) +
                                                                                                                               1i32)
    (A_beam0_cplx0_dish24, A_beam0_cplx1_dish24, A_beam0_cplx0_dish28, A_beam0_cplx1_dish28) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                               ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                                0,
                                                                                                                                                                24) ÷
                                                                                                                                     4) %
                                                                                                                                ...
                                                                                                                                49152) +
                                                                                                                               1i32)
    (A_beam8_cplx0_dish24, A_beam8_cplx1_dish24, A_beam8_cplx0_dish28, A_beam8_cplx1_dish28) = IndexSpaces.unsafe_load4_global(A_memory,
                                                                                                                               (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                                                                 0,
                                                                                                                                                                 24) ÷
                                                                                                                                      4) %
                                                                                                                                ...
                                                                                                                                49152) +
                                                                                                                               1i32)
    (A_beam0_cplx0_dish0, A_beam0_cplx1_dish0) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish0, A_beam0_cplx1_dish0),
                                                  IndexSpaces.get_hi16(A_beam0_cplx0_dish0, A_beam0_cplx1_dish0))
    (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish0, A_beam8_cplx1_dish0),
                                                  IndexSpaces.get_hi16(A_beam8_cplx0_dish0, A_beam8_cplx1_dish0))
    (A_beam0_cplx0_dish4, A_beam0_cplx1_dish4) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish4, A_beam0_cplx1_dish4),
                                                  IndexSpaces.get_hi16(A_beam0_cplx0_dish4, A_beam0_cplx1_dish4))
    (A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish4, A_beam8_cplx1_dish4),
                                                  IndexSpaces.get_hi16(A_beam8_cplx0_dish4, A_beam8_cplx1_dish4))
    (A_beam0_cplx0_dish8, A_beam0_cplx1_dish8) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish8, A_beam0_cplx1_dish8),
                                                  IndexSpaces.get_hi16(A_beam0_cplx0_dish8, A_beam0_cplx1_dish8))
    (A_beam8_cplx0_dish8, A_beam8_cplx1_dish8) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish8, A_beam8_cplx1_dish8),
                                                  IndexSpaces.get_hi16(A_beam8_cplx0_dish8, A_beam8_cplx1_dish8))
    (A_beam0_cplx0_dish12, A_beam0_cplx1_dish12) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish12, A_beam0_cplx1_dish12),
                                                    IndexSpaces.get_hi16(A_beam0_cplx0_dish12, A_beam0_cplx1_dish12))
    (A_beam8_cplx0_dish12, A_beam8_cplx1_dish12) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish12, A_beam8_cplx1_dish12),
                                                    IndexSpaces.get_hi16(A_beam8_cplx0_dish12, A_beam8_cplx1_dish12))
    (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish16, A_beam0_cplx1_dish16),
                                                    IndexSpaces.get_hi16(A_beam0_cplx0_dish16, A_beam0_cplx1_dish16))
    (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish16, A_beam8_cplx1_dish16),
                                                    IndexSpaces.get_hi16(A_beam8_cplx0_dish16, A_beam8_cplx1_dish16))
    (A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish20, A_beam0_cplx1_dish20),
                                                    IndexSpaces.get_hi16(A_beam0_cplx0_dish20, A_beam0_cplx1_dish20))
    (A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish20, A_beam8_cplx1_dish20),
                                                    IndexSpaces.get_hi16(A_beam8_cplx0_dish20, A_beam8_cplx1_dish20))
    (A_beam0_cplx0_dish24, A_beam0_cplx1_dish24) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish24, A_beam0_cplx1_dish24),
                                                    IndexSpaces.get_hi16(A_beam0_cplx0_dish24, A_beam0_cplx1_dish24))
    (A_beam8_cplx0_dish24, A_beam8_cplx1_dish24) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish24, A_beam8_cplx1_dish24),
                                                    IndexSpaces.get_hi16(A_beam8_cplx0_dish24, A_beam8_cplx1_dish24))
    (A_beam0_cplx0_dish28, A_beam0_cplx1_dish28) = (IndexSpaces.get_lo16(A_beam0_cplx0_dish28, A_beam0_cplx1_dish28),
                                                    IndexSpaces.get_hi16(A_beam0_cplx0_dish28, A_beam0_cplx1_dish28))
    (A_beam8_cplx0_dish28, A_beam8_cplx1_dish28) = (IndexSpaces.get_lo16(A_beam8_cplx0_dish28, A_beam8_cplx1_dish28),
                                                    IndexSpaces.get_hi16(A_beam8_cplx0_dish28, A_beam8_cplx1_dish28))
    (A_beam0_cplx0_dish0, A_beam0_cplx1_dish0) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish0, A_beam0_cplx1_dish0),
                                                  IndexSpaces.get_hi8(A_beam0_cplx0_dish0, A_beam0_cplx1_dish0))
    (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish0, A_beam8_cplx1_dish0),
                                                  IndexSpaces.get_hi8(A_beam8_cplx0_dish0, A_beam8_cplx1_dish0))
    (A_beam0_cplx0_dish4, A_beam0_cplx1_dish4) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish4, A_beam0_cplx1_dish4),
                                                  IndexSpaces.get_hi8(A_beam0_cplx0_dish4, A_beam0_cplx1_dish4))
    (A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish4, A_beam8_cplx1_dish4),
                                                  IndexSpaces.get_hi8(A_beam8_cplx0_dish4, A_beam8_cplx1_dish4))
    (A_beam0_cplx0_dish8, A_beam0_cplx1_dish8) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish8, A_beam0_cplx1_dish8),
                                                  IndexSpaces.get_hi8(A_beam0_cplx0_dish8, A_beam0_cplx1_dish8))
    (A_beam8_cplx0_dish8, A_beam8_cplx1_dish8) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish8, A_beam8_cplx1_dish8),
                                                  IndexSpaces.get_hi8(A_beam8_cplx0_dish8, A_beam8_cplx1_dish8))
    (A_beam0_cplx0_dish12, A_beam0_cplx1_dish12) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish12, A_beam0_cplx1_dish12),
                                                    IndexSpaces.get_hi8(A_beam0_cplx0_dish12, A_beam0_cplx1_dish12))
    (A_beam8_cplx0_dish12, A_beam8_cplx1_dish12) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish12, A_beam8_cplx1_dish12),
                                                    IndexSpaces.get_hi8(A_beam8_cplx0_dish12, A_beam8_cplx1_dish12))
    (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish16, A_beam0_cplx1_dish16),
                                                    IndexSpaces.get_hi8(A_beam0_cplx0_dish16, A_beam0_cplx1_dish16))
    (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish16, A_beam8_cplx1_dish16),
                                                    IndexSpaces.get_hi8(A_beam8_cplx0_dish16, A_beam8_cplx1_dish16))
    (A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish20, A_beam0_cplx1_dish20),
                                                    IndexSpaces.get_hi8(A_beam0_cplx0_dish20, A_beam0_cplx1_dish20))
    (A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish20, A_beam8_cplx1_dish20),
                                                    IndexSpaces.get_hi8(A_beam8_cplx0_dish20, A_beam8_cplx1_dish20))
    (A_beam0_cplx0_dish24, A_beam0_cplx1_dish24) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish24, A_beam0_cplx1_dish24),
                                                    IndexSpaces.get_hi8(A_beam0_cplx0_dish24, A_beam0_cplx1_dish24))
    (A_beam8_cplx0_dish24, A_beam8_cplx1_dish24) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish24, A_beam8_cplx1_dish24),
                                                    IndexSpaces.get_hi8(A_beam8_cplx0_dish24, A_beam8_cplx1_dish24))
    (A_beam0_cplx0_dish28, A_beam0_cplx1_dish28) = (IndexSpaces.get_lo8(A_beam0_cplx0_dish28, A_beam0_cplx1_dish28),
                                                    IndexSpaces.get_hi8(A_beam0_cplx0_dish28, A_beam0_cplx1_dish28))
    (A_beam8_cplx0_dish28, A_beam8_cplx1_dish28) = (IndexSpaces.get_lo8(A_beam8_cplx0_dish28, A_beam8_cplx1_dish28),
    ...
    for T1 in 0:128:2047
        ...
        for T2 in 0:32:127
                ...
                (E_dish0_time0, E_dish4_time0, E_dish8_time0, E_dish12_time0) = IndexSpaces.unsafe_load4_global(E_memory,
                                                                                                                ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                                                                                 ...
                                                                                                                 (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                   ...
                                                                                                                   128) % 32768) *
                                                                                                                 4096) + 1i32)
                (E_dish0_time16, E_dish4_time16, E_dish8_time16, E_dish12_time16) = IndexSpaces.unsafe_load4_global(E_memory,
                                                                                                                    ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                                                                                                                   0,
                                                                                                                                                   512) ÷
                                                                                                                        16) % 2) %
                                                                                                                     ...
                                                                                                                     ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                                                                                       ...
                                                                                                                       128) % 32768) *
                                                                                                                     4096) + 1i32)
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish0_time0
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 4) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish4_time0
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 8) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish8_time0
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 12) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish0_time16
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 4) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish4_time16
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 8) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish8_time16
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 12) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] = E_dish12_time16
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((((D ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0x01]
                    ...
                    Ju_shared[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + ((B ÷ 8) % 2) * 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] = Ju_time0
                    Ju_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + 1) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + ((B ÷ 8) % 2) * 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] = Ju_time1
                end
                let
                    B = 8
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time0 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time0 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time0 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time8 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time8 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time8 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time8 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time16 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time16 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time16 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time16 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time24 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time24 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time24 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time24 = Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
        ...
        (Jper_time32, Jper_time96) = (IndexSpaces.get_lo16(Jper_time32, Jper_time96),
                                      IndexSpaces.get_hi16(Jper_time32, Jper_time96))
        is_lo_thread = IndexSpaces.cuda_threadidx() & 0x00000004 == 0x00
        (Jper_time0, Jper_time32) = let
            src = if is_lo_thread
                Jper_time32
        ...
        IndexSpaces.unsafe_store4_global!(J_memory,
                                          ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 +
                                             (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96) *
                                           262144 +
                                           (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 32 +
                                             ...
                                             ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) ÷ 4) % 8192 +
                                           (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 16) % 2) % 2) *
                                           8192 +
                                           (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 32) % 16) % 16) *
                                           16384) +
                                          0 +
                                          0x01,
