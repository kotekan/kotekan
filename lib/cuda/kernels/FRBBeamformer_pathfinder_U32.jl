...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1891 =#
        ...
        if !(
            0i32 ≤ Fmin ≤ Fmax ≤ 2048 && (
                (Fmax - Fmin) % 32 == 0i32 &&
                (0i32 ≤ F̄min ≤ F̄max ≤ 4096 && ((F̄max - F̄min) % 32 == 0i32 && F̄max - F̄min == Fmax - Fmin))
            )
        )
            info = 3
            if true
        ...
        if let
            ...
            W_dishM0_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 2048) % 2048) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + 0 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24) + 0x01]
            W_dishM4_polr0 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 2048) % 2048) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) + 4) % 8 + 0 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24) + 0x01]
            W_dishM0_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 2048) % 2048) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8 + 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24) + 0x01]
            W_dishM4_polr1 = W_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 2048) % 2048) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) + 4) % 8 + 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 3) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 24) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:48:1007
            ...
            let
                Freg1_dish0 = Fsh1_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish6 = Fsh1_shared[(((6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((6 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish12 = Fsh1_shared[(((12 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((12 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish18 = Fsh1_shared[(((18 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((18 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish24 = Fsh1_shared[(((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish30 = Fsh1_shared[(((30 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((30 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish36 = Fsh1_shared[(((36 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((36 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish42 = Fsh1_shared[(((42 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((42 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish48 = Fsh1_shared[(((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish54 = Fsh1_shared[(((54 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((54 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                Freg1_dish60 = Fsh1_shared[(((60 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) % 8) * 32 + (((60 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) ÷ 8) % 8) * 260 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 24 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) % 24) + 0x01]
                IndexSpaces.cuda_sync_threads()
            ...
            let
                ...
                if let
                    ...
                    Freg2_dishM0_time0 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + (((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    ...
                    Freg2_dishM0_time3 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((3 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time3 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((3 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time6 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((6 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time6 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((6 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time9 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((9 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time9 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((9 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time12 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((12 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time12 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((12 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time15 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((15 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time15 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((15 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time18 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((18 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time18 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((18 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM0_time21 = Fsh2_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((21 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                    Freg2_dishM4_time21 = Fsh2_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 2) * 2 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 2) % 8) * 33 + ((21 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) ÷ 2) % 3) % 24 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 16) % 2) * 2) % 3) * 290 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 870) + 0x01]
                end
                IndexSpaces.cuda_sync_threads()
                let
                    t_inner_hi = 0
                    for t_inner_lo in 0:6:23
                        ...
                        let
                            ...
                            if true
                                G_polr0 = Gsh_shared[(0 + ((((t % 6 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + ((IndexSpaces.assume_inrange(t_inner_lo, 0, 6, 24) ÷ 6) % 4) * 6) + ((t_inner_hi ÷ 24) % 2) * 24) % 6) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 2) % 2) * 784 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 2 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 16) % 2) * 98 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2) + 0x01]
                                G_polr1 = Gsh_shared[(8 + ((((t % 6 + ((IndexSpaces.assume_inrange(t_outer, 0, 48, 1008) ÷ 48) % 21) * 48) + ((IndexSpaces.assume_inrange(t_inner_lo, 0, 6, 24) ÷ 6) % 4) * 6) + ((t_inner_hi ÷ 24) % 2) * 24) % 6) * 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 2) * 1576 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 2) % 2) * 784 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) % 2 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 4) % 2) * 392 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 16) % 2) * 98 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) ÷ 8) % 2) * 196 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) % 4) * 2) + 0x01]
                            end
                            X_polr0 = G_polr0
                            X_polr1 = G_polr1
                                    ...
                                    if 0i32 ≤
                                       ...
                                       24
                                        I_memory[let
                                            ...
                                            length = 402653184
                                            mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 6) % 6) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 24) * 8 + ((IndexSpaces.assume_inrange(dstime, 0, 1, 512) % 512) % 512) * 786432 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 2048) % 4096) * 192 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 2) ÷ 2) % 8) + 0) + offset, length)
                                        end + 0x01] = I
                                    end
                                    I = zero(Float16x2)
                                    t_running = 0
