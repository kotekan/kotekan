    ...
    for T1 in 0:128:32767
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                ...
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 544 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 16) ÷ 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 16 + ((0::Int32 ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 32) * 17) + 0) + 0x01] =
                    E_dish0_time0
                ...
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 544 + ((((12::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 16) ÷ 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 16 + ((0::Int32 ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 32) * 17) + 0) + 0x01] =
                    E_dish12_time0
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 544 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 16) ÷ 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 16 + ((8::Int32 ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 32) * 17) + 0) + 0x01] =
                    E_dish0_time8
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 544 + ((((4::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 16) ÷ 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 16 + ((8::Int32 ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 32) * 17) + 0) + 0x01] =
                    E_dish4_time8
                E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 544 + ((((8::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 16) ÷ 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 16 + ((8::Int32 ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 32) * 17) + 0) + 0x01] =
            ...
            for T3 in 0:8:31
                let B = 0
                    ...
                    Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 8) % 16 + ((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + 0::Int32 % 2 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 2) % 32) * 20) + 0) + 0x01] =
                        Ju_time0
                    Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) % 2) * 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 8) % 16 + ((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + 1::Int32 % 2 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 32768) ÷ 128) % 256) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 2) % 32) * 20) + 0) + 0x01] =
                        Ju_time1
                end
            end
            IndexSpaces.cuda_sync_threads()
