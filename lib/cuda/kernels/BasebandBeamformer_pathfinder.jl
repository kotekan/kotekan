...
@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:890 =#
    ...
    s_polr0 = s_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16 + 0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) ÷ 16) % 128) % 128) * 32) + 0x01]
    s_polr1 = s_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16 + 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) ÷ 16) % 128) % 128) * 32) + 0x01]
    s_polr0 = s_polr0 - 2
    s_polr1 = s_polr1 - 2
    ...
    for T1 in 0:128:2047
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                        ...
                        (
                            (
                                (
                                    (
                                        (
                                            (8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16) +
                                            ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128
                                        ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048
                                    ) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8
                ...
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16) ÷ 4) % 16 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 4) ÷ 4) % 16 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 8) ÷ 4) % 16 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 12) ÷ 4) % 16 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16) ÷ 4) % 16 + ((((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish0_time8
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 4) ÷ 4) % 16 + ((((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish4_time8
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 8) ÷ 4) % 16 + ((((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                ...
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + 12) ÷ 4) % 16 + ((((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0) + 0x01] =
                        E_dish12_time8
                end
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 16 + ((D ÷ 4) % 4) * 4) ÷ 4) % 16 + (((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 17 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 544) + 0x01]
                    ...
                    if true
                        Ju_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 20 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 16) + 0) + 0x01] =
                            Ju_time0
                    end
                    if true
                        Ju_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 1) % 32) * 20 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) % 2) * 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 16) + 0) + 0x01] =
                            Ju_time1
                    end
                end
            end
            IndexSpaces.cuda_sync_threads()
            Ju_polr0_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 0 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr1_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr0_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 0 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr1_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr0_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 0 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr1_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr0_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 0 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
            Ju_polr1_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 2048) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 20 + 640 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4) % 16) + 0x01]
