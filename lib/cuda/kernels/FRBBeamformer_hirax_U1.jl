...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1881 =#
        ...
        if let
            ...
            W_polr0 = W_memory[(((0::Int32 % 2) % 2) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64) + 0x01]
            W_polr1 = W_memory[(((1::Int32 % 2) % 2) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2) % 4) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 8) * 2) % 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 64) + 0x01]
        end
        I = zero(Float16x2)
        dstime = 0
        t_running = 0
        for t_outer in 0:64:65535
            ...
            let
                ...
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((0::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (0::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish0_time16
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish4_time16
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish8_time16
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((16::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (16::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish12_time16
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish0_time32
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish4_time32
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish8_time32
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((32::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (32::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish12_time32
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((0::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((0::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish0_time48
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((4::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((4::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish4_time48
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((8::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((8::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish8_time48
                end
                if true
                    Fsh1_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) ÷ 8) % 32) * 257 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16 + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((48::Int32 ÷ 16) % 2) * 16) % 32 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16 + ((12::Int32 ÷ 4) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + (48::Int32 ÷ 32) % 2) + ((12::Int32 ÷ 8) % 2) * 2) % 8) * 32) + 0) + 0x01] =
                        E_dish12_time48
                end
                ...
                let t_inner_hi = 0
                    for t_inner_lo in 0:8:31
                        ...
                        let t = 0
                            ...
                            if true
                                G_polr0 = Gsh_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 16) % 2) * 258 + ((0::Int32 % 2) % 2) * 16 + ((((t::Int32 % 8 + ((t_inner_hi::Int32 ÷ 32) % 2) * 32) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 4) % 2) * 1032 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 8) % 2) * 516 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 2) * 4144 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 2) % 2) * 2064) + 0x01]
                                G_polr1 = Gsh_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 16) % 2) * 258 + ((1::Int32 % 2) % 2) * 16 + ((((t::Int32 % 8 + ((t_inner_hi::Int32 ÷ 32) % 2) * 32) + ((IndexSpaces.assume_inrange(t_outer::Int32, 0, 64, 65536) ÷ 64) % 1024) * 64) + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 8, 32) ÷ 8) % 4) * 8) % 8) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 2 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 2) % 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 4) % 2) * 1032 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 4 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 8) % 2) * 516 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) % 2) * 4144 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 2) ÷ 2) % 2) * 2064) + 0x01]
                            end
                            X_polr0 = G_polr0
                            X_polr1 = G_polr1
                                    ...
                                    if 0i32 ≤
                                       ...
                                       32
                                        I_memory[let
                                            ...
                                            length = 1073741824
                                            mod(((((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 1024) % 1024) % 1024) * 1048576 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 64) % 64) % 2048) * 512 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 2) ÷ 2) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) % 32) * 16) + 0) + offset, length)
                                        end + 0x01] = I
                                    end
                                    I = zero(Float16x2)
                                    t_running = 0
