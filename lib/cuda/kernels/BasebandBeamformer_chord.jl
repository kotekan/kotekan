@inbounds begin #= /home/dstn/kotekan/julia/kernels/bb.jl:743 =#
    ...
    info_memory[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)%32)%32+((IndexSpaces.assume_inrange(
        ...
        0,
        512,
    )%512)%512)*768+((IndexSpaces.assume_inrange(
        ...
        for T2 = 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                ...
                E_shared[((((IndexSpaces.assume_inrange(
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish0_time0
                E_shared[((((4+(IndexSpaces.assume_inrange(
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish4_time0
                E_shared[((((8+(IndexSpaces.assume_inrange(
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish8_time0
                E_shared[((((12+(IndexSpaces.assume_inrange(
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    0,
                    32,
                )÷8)%4)+16)+((IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_warpidx(),
                    0,
                    24,
                )÷4)%4)*4)+((IndexSpaces.assume_inrange(
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish0_time16
                E_shared[((((4+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish4_time16
                E_shared[((((8+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish8_time16
                E_shared[((((12+(IndexSpaces.assume_inrange(
                    IndexSpaces.cuda_threadidx(),
                    0,
                    32,
                    ...
                    32,
                    128,
                )÷32)%4)*32)%32)*129)+0+0x01] = E_dish12_time16
            end
            ...
            for T3 = 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((((D÷4)%8)*4+(IndexSpaces.assume_inrange(
                            IndexSpaces.cuda_threadidx(),
                            0,
                            32,
                        )%4)*32)+(IndexSpaces.assume_inrange(
                            IndexSpaces.cuda_warpidx(),
                            0,
                            24,
                        )%4)*128)÷4)%128+(((((((IndexSpaces.assume_inrange(
                    ...
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        ...
                        0,
                        32,
                    )÷4)%8+((B÷8)%2)*8)+((IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_warpidx(),
                        0,
                        24,
                    )÷4)%6)*16)%96+(((((((IndexSpaces.assume_inrange(
                        T1,
                        0,
                        128,
                        2048,
                        ...
                        32,
                        128,
                    )÷32)%4)*32)%32)*100+((((IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_warpidx(),
                        0,
                        24,
                    )%4)*128)÷128)%4)*3200)+0+0x01] = Ju_time0
                    Ju_shared[((((IndexSpaces.assume_inrange(
                        IndexSpaces.cuda_threadidx(),
                        0,
                        32,
                        ...
                        0,
                        24,
                    )%4)*128)÷128)%4)*3200)+0+0x01] = Ju_time1
                end
                let
                    B = 8
            ...
            Ju_dish0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                32,
            )÷8)%4)%96+((((((IndexSpaces.assume_inrange(
                T1,
                0,
                128,
                2048,
                ...
                0,
                32,
            )%8)+((IndexSpaces.assume_inrange(T2, 0, 32, 128)÷32)%4)*32)%32)*100+0)+0x01]
            Ju_dish128_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                32,
            )%8)+((IndexSpaces.assume_inrange(T2, 0, 32, 128)÷32)%4)*32)%32)*100+3200)+0x01]
            Ju_dish256_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                32,
            )%8)+((IndexSpaces.assume_inrange(T2, 0, 32, 128)÷32)%4)*32)%32)*100+6400)+0x01]
            Ju_dish384_time0 = Ju_shared[(((IndexSpaces.assume_inrange(
                ...
                0,
                32,
            )%8)+((IndexSpaces.assume_inrange(T2, 0, 32, 128)÷32)%4)*32)%32)*100+9600)+0x01]
