...
@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:940 =#
    info = 1
    if true
        info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 512) % 512) * 768) + 0) + 0x01] =
            info
    end
    Tmin = Tmin_memory[0 + 0x01]
    Tmax = Tmax_memory[0 + 0x01]
    if !(0i32 ≤ Tmin ≤ Tmax ≤ 16384 && (Tmax - Tmin) % 128 == 0i32)
        info = 2
        if true
            info_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 512) % 512) * 768) + 0) + 0x01] =
                info
    ...
    for T1 in 0:128:511
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                                    ...
                                    (
                                        (
                                            (
                                                ...
                                                ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512
                                            ) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128
                ...
                if true
                    E_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    E_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 4) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    E_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 8) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    E_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 12) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    E_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish0_time16
                end
                if true
                    E_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 4) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish4_time16
                end
                if true
                    E_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 8) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish8_time16
                end
                if true
                    E_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + 12) ÷ 4) % 128) + 0) + 0x01] =
                        E_dish12_time16
                end
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 129 + (((((D ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0x01]
                    ...
                    if true
                        Ju_shared[(((((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) % 32) * 100 + ((((B ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0) + 0x01] =
                            Ju_time0
                    end
                    if true
                        Ju_shared[((((((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + 1) % 32) * 100 + ((((B ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0) + 0x01] =
                            Ju_time1
                    end
                end
                let
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0) + 0x01]
            Ju_dish128_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200) + 0x01]
            Ju_dish256_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400) + 0x01]
            Ju_dish384_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600) + 0x01]
            Ju_dish0_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0) + 0x01]
            Ju_dish128_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200) + 0x01]
            Ju_dish256_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400) + 0x01]
            Ju_dish384_time8 = Ju_shared[((((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600) + 0x01]
            Ju_dish0_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0) + 0x01]
            Ju_dish128_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200) + 0x01]
            Ju_dish256_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400) + 0x01]
            Ju_dish384_time16 = Ju_shared[((((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600) + 0x01]
            Ju_dish0_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0) + 0x01]
            Ju_dish128_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200) + 0x01]
            Ju_dish256_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400) + 0x01]
            Ju_dish384_time24 = Ju_shared[((((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 512) + ((IndexSpaces.assume_inrange(T1, 0, 128, 512) ÷ 128) % 4) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600) + 0x01]
            ...
            IndexSpaces.unsafe_store4_global!(
                ...
                (
                    (
                        ...
                        (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 32) % 16) % 16) * 1024 +
                        (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 16) % 2) % 2) * 512
                    ) + 0
                ) + 0x01,
