@fastmath @inbounds(begin #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:1610 =#
                        info = 1
                        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                        0,
                        128) % 128) % 128) * 512 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                        0,
                        ...
                        Gains = G_memory[(((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                         0,
                                         32) ÷ 16) % 2) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                         0,
                                         32) % 2) * 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                         0,
                                         32) ÷ 8) % 2) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                         0,
                                         32) ÷ 4) % 2) * 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                         0,
                                         32) ÷ 2) % 2) * 2) ÷ 2) % 512 + 0x01]
                        ...
                        (Γ¹0, Γ¹1) = let
                            k = Ubits
                            @assert U == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:711 =#
                            m = 3
                            n = k - m
                            @assert 0 ≤ m                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:714 =#
                            @assert 0 ≤ n                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:715 =#
                            thread = IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)
                            ...
                            (Γ¹0, Γ¹1) = (cispi((((-2i32) * timehi0 * freqlo) / Float32(2^m)) % 2.0f0),
                        ...
                        (Γ²0, Γ²1) = let
                            k = Ubits
                            @assert U == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:772 =#
                            m = 3
                            n = k - m
                            @assert 0 ≤ m                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:775 =#
                            @assert 0 ≤ n                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:776 =#
                            thread = IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)
                            thread0 = (thread ÷ (1i32)) % (2i32)
                            thread1 = (thread ÷ (2i32)) % (2i32)
                            thread2 = (thread ÷ (4i32)) % (2i32)
                            ...
                            elseif U == 128
                                ...
                                @assert false                        #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:796 =#
                            end
                            freqlo = (1i32) * thread2 + (2i32) * thread3 + (4i32) * thread4
                        ...
                        (Γ³0, Γ³1) = let
                            k = Ubits
                            @assert U == 2^k                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:847 =#
                            m = 3
                            n = k - m
                            @assert 0 ≤ m                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:850 =#
                            @assert 0 ≤ n                    #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:851 =#
                            thread = IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32)
                            thread0 = (thread ÷ (1i32)) % (2i32)
                            thread1 = (thread ÷ (2i32)) % (2i32)
                            thread2 = (thread ÷ (4i32)) % (2i32)
                            ...
                            elseif U == 128
                                ...
                                @assert false                        #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:871 =#
                            end
                            if U == 16
                                freqhi = (1i32) * thread2
                            ...
                            elseif U == 128
                                ...
                                @assert false                        #= /home/eschnett/src/kotekan/julia/kernels/upchan.jl:890 =#
                            end
                            delta = dish == dish_in
                            (Γ³0, Γ³1) = (delta * cispi((((-2i32) * timelo0 * freqhi) / Float32(2^n)) % 2.0f0),
                        ...
                        for t_outer in 0:256:32767
                            (E_dish0, E_dish4, E_dish8, E_dish12) = IndexSpaces.unsafe_load4_global(E_memory,
                            ...
                            (E2_dish0_time0, E2_dish0_time32) = (IndexSpaces.get_lo16(E1_dish0_time0, E1_dish0_time32),
                                                                 IndexSpaces.get_hi16(E1_dish0_time0, E1_dish0_time32))
                            (E2_dish4_time0, E2_dish4_time32) = (IndexSpaces.get_lo16(E1_dish4_time0, E1_dish4_time32),
                            ...
                            F_dish4 = E2_dish4
                            F_dish6 = E2_dish6
                            F_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            32768) ÷ 256) % 128) * 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 8) % 2) * 130 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 16) % 2) * 65 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 64) % 4) * 2081 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 8) % 2) * 8) ÷ 4) % 32 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 4) % 2) * 260 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 2) % 2) * 520 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            256,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) % 2) * 1040 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0 + 0x01] = F_dish0
                            F_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 64) % 4) * 2081 + ((((2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) % 2) * 1040 + (((((2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0 + 0x01] = F_dish2
                            F_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 64) % 4) * 2081 + ((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) % 2) * 1040 + (((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0 + 0x01] = F_dish4
                            F_shared[((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 16) % 2) * 16 + ((IndexSpaces.assume_inrange(t_outer,
                            0,
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) ÷ 64) % 4) * 2081 + ((((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            ...
                            16) ÷ 16) % 4) * 64) + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                            0,
                            16) % 16) % 2) * 1040 + (((((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                            0,
                            128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                            0,
                            32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0 + 0x01] = F_dish6
                            IndexSpaces.cuda_sync_threads()
                            for t_inner in 0:64:255
                                let
                                    dish = 0
                                    F_in_dish0 = F_shared[(((((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          64,
                                                          256) ÷ 64) % 4) * 64) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) % 4) * 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) ÷ 8) % 2) * 130 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          ...
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) ÷ 16) % 2) * 65 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          ...
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) ÷ 64) % 4) * 2081 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                          0,
                                                          16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                          0,
                                                          128) % 4) * 128) ÷ 4) % 32 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          ...
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) ÷ 4) % 2) * 260 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          ...
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) ÷ 2) % 2) * 520 + (((((((IndexSpaces.assume_inrange(t_outer,
                                                          0,
                                                          256,
                                                          32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                          0,
                                                          ...
                                                          32) ÷ 4) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                          0,
                                                          32) ÷ 8) % 4) % 2) * 1040 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                          0,
                                                          16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                          0,
                                                          128) % 4) * 128) ÷ 2) % 2) * 32) + 0x01]
                                    F_in_dish32 = F_shared[(((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 32) ÷ 4) % 32 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 32) ÷ 2) % 2) * 32) + 0x01]
                                    F_in_dish64 = F_shared[(((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 64) ÷ 4) % 32 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 64) ÷ 2) % 2) * 32) + 0x01]
                                    F_in_dish96 = F_shared[(((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 96) ÷ 4) % 32 + ((((((((IndexSpaces.assume_inrange(t_outer,
                                                           0,
                                                           256,
                                                           32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                                           0,
                                                           ...
                                                           16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                           0,
                                                           128) % 4) * 128) + 96) ÷ 2) % 2) * 32) + 0x01]
                                    (E_cplx0_dish0, E_cplx1_dish0, E_cplx0_dish1, E_cplx1_dish1) = convert(NTuple{4,Float16x2},
                                                                                                           F_in_dish0)
                                    (E_cplx0_dish32, E_cplx1_dish32, E_cplx0_dish33, E_cplx1_dish33) = convert(NTuple{4,Float16x2},
                                                                                                               F_in_dish32)
                                    (E_cplx0_dish64, E_cplx1_dish64, E_cplx0_dish65, E_cplx1_dish65) = convert(NTuple{4,Float16x2},
                                                                                                               F_in_dish64)
                                    (E_cplx0_dish96, E_cplx1_dish96, E_cplx0_dish97, E_cplx1_dish97) = convert(NTuple{4,Float16x2},
                                                                                                               F_in_dish96)
                                    W_m0 = Wpfb_mtaps0
                                    W_m1 = Wpfb_mtaps1
                                    W_m2 = Wpfb_mtaps2
                                    ...
                                    E_ringbuf_m0_cplx1_dish1) = convert(NTuple{4,Float16x2}, F_ringbuf_m0_dish0)
                                    (E_ringbuf_m0_cplx0_dish32,
                                    E_ringbuf_m0_cplx1_dish32,
                                    E_ringbuf_m0_cplx0_dish33,
                                    E_ringbuf_m0_cplx1_dish33) = convert(NTuple{4,Float16x2}, F_ringbuf_m0_dish32)
                                    (E_ringbuf_m0_cplx0_dish64,
                                    E_ringbuf_m0_cplx1_dish64,
                                    E_ringbuf_m0_cplx0_dish65,
                                    E_ringbuf_m0_cplx1_dish65) = convert(NTuple{4,Float16x2}, F_ringbuf_m0_dish64)
                                    (E_ringbuf_m0_cplx0_dish96,
                                    E_ringbuf_m0_cplx1_dish96,
                                    E_ringbuf_m0_cplx0_dish97,
                                    E_ringbuf_m0_cplx1_dish97) = convert(NTuple{4,Float16x2}, F_ringbuf_m0_dish96)
                                    ...
                                    E_ringbuf_m1_cplx1_dish1) = convert(NTuple{4,Float16x2}, F_ringbuf_m1_dish0)
                                    (E_ringbuf_m1_cplx0_dish32,
                                    E_ringbuf_m1_cplx1_dish32,
                                    E_ringbuf_m1_cplx0_dish33,
                                    E_ringbuf_m1_cplx1_dish33) = convert(NTuple{4,Float16x2}, F_ringbuf_m1_dish32)
                                    (E_ringbuf_m1_cplx0_dish64,
                                    E_ringbuf_m1_cplx1_dish64,
                                    E_ringbuf_m1_cplx0_dish65,
                                    E_ringbuf_m1_cplx1_dish65) = convert(NTuple{4,Float16x2}, F_ringbuf_m1_dish64)
                                    (E_ringbuf_m1_cplx0_dish96,
                                    E_ringbuf_m1_cplx1_dish96,
                                    E_ringbuf_m1_cplx0_dish97,
                                    E_ringbuf_m1_cplx1_dish97) = convert(NTuple{4,Float16x2}, F_ringbuf_m1_dish96)
                                    ...
                                    E_ringbuf_m2_cplx1_dish1) = convert(NTuple{4,Float16x2}, F_ringbuf_m2_dish0)
                                    (E_ringbuf_m2_cplx0_dish32,
                                    E_ringbuf_m2_cplx1_dish32,
                                    E_ringbuf_m2_cplx0_dish33,
                                    E_ringbuf_m2_cplx1_dish33) = convert(NTuple{4,Float16x2}, F_ringbuf_m2_dish32)
                                    (E_ringbuf_m2_cplx0_dish64,
                                    E_ringbuf_m2_cplx1_dish64,
                                    E_ringbuf_m2_cplx0_dish65,
                                    E_ringbuf_m2_cplx1_dish65) = convert(NTuple{4,Float16x2}, F_ringbuf_m2_dish64)
                                    (E_ringbuf_m2_cplx0_dish96,
                                    E_ringbuf_m2_cplx1_dish96,
                                    E_ringbuf_m2_cplx0_dish97,
                                    E_ringbuf_m2_cplx1_dish97) = convert(NTuple{4,Float16x2}, F_ringbuf_m2_dish96)
                                    ...
                                    (WW_cplx0_dish0, WW_cplx1_dish0) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                 Γ¹_cplx1_cplx_in0,
                                                                                                 Γ¹_cplx0_cplx_in1,
                                                                                                 Γ¹_cplx1_cplx_in1),
                                                                                                (XX_cplx_in0_dish0,
                                    ...
                                    (WW_cplx0_dish1, WW_cplx1_dish1) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                 Γ¹_cplx1_cplx_in0,
                                                                                                 Γ¹_cplx0_cplx_in1,
                                                                                                 Γ¹_cplx1_cplx_in1),
                                                                                                (XX_cplx_in0_dish1,
                                    ...
                                    (WW_cplx0_dish32, WW_cplx1_dish32) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish32,
                                                                                                  ...
                                                                                                  (WW_cplx0_dish32,
                                                                                                   WW_cplx1_dish32))
                                    (WW_cplx0_dish33, WW_cplx1_dish33) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish33,
                                                                                                  ...
                                                                                                  (WW_cplx0_dish33,
                                                                                                   WW_cplx1_dish33))
                                    (WW_cplx0_dish64, WW_cplx1_dish64) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish64,
                                                                                                  ...
                                                                                                  (WW_cplx0_dish64,
                                                                                                   WW_cplx1_dish64))
                                    (WW_cplx0_dish65, WW_cplx1_dish65) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish65,
                                                                                                  ...
                                                                                                  (WW_cplx0_dish65,
                                                                                                   WW_cplx1_dish65))
                                    (WW_cplx0_dish96, WW_cplx1_dish96) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish96,
                                                                                                  ...
                                                                                                  (WW_cplx0_dish96,
                                                                                                   WW_cplx1_dish96))
                                    (WW_cplx0_dish97, WW_cplx1_dish97) = IndexSpaces.mma_m16n8k16((Γ¹_cplx0_cplx_in0,
                                                                                                   Γ¹_cplx1_cplx_in0,
                                                                                                   Γ¹_cplx0_cplx_in1,
                                                                                                   Γ¹_cplx1_cplx_in1),
                                                                                                  (XX_cplx_in0_dish97,
                                    ...
                                    (YY_cplx0_dish0, YY_cplx1_dish0) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish0,
                                    ...
                                    (YY_cplx0_dish1, YY_cplx1_dish1) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish1,
                                    ...
                                    (YY_cplx0_dish32, YY_cplx1_dish32) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish32,
                                                                                                  ...
                                                                                                  (YY_cplx0_dish32,
                                                                                                   YY_cplx1_dish32))
                                    (YY_cplx0_dish33, YY_cplx1_dish33) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish33,
                                                                                                  ...
                                                                                                  (YY_cplx0_dish33,
                                                                                                   YY_cplx1_dish33))
                                    (YY_cplx0_dish64, YY_cplx1_dish64) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish64,
                                                                                                  ...
                                                                                                  (YY_cplx0_dish64,
                                                                                                   YY_cplx1_dish64))
                                    (YY_cplx0_dish65, YY_cplx1_dish65) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish65,
                                                                                                  ...
                                                                                                  (YY_cplx0_dish65,
                                                                                                   YY_cplx1_dish65))
                                    (YY_cplx0_dish96, YY_cplx1_dish96) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish96,
                                                                                                  ...
                                                                                                  (YY_cplx0_dish96,
                                                                                                   YY_cplx1_dish96))
                                    (YY_cplx0_dish97, YY_cplx1_dish97) = IndexSpaces.mma_m16n8k16((Γ³_cplx0_cplx_in0_dish97,
                                    ...
                                    F̄_out_dish0 = Int4x8((E5_cplx0_dish0,
                                                           E5_cplx1_dish0,
                                                           E5_cplx0_dish1,
                                                           E5_cplx1_dish1))
                                    F̄_out_dish32 = Int4x8((E5_cplx0_dish32,
                                                            E5_cplx1_dish32,
                                                            E5_cplx0_dish33,
                                                            E5_cplx1_dish33))
                                    F̄_out_dish64 = Int4x8((E5_cplx0_dish64,
                                                            E5_cplx1_dish64,
                                                            E5_cplx0_dish65,
                                                            E5_cplx1_dish65))
                                    F̄_out_dish96 = Int4x8((E5_cplx0_dish96,
                                                            E5_cplx1_dish96,
                                                            E5_cplx0_dish97,
                                                            E5_cplx1_dish97))
                                    F̄_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) % 2) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) ÷ 4) % 2) * 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) ÷ 2) % 2) * 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) ÷ 16) % 2) * 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) ÷ 8) % 16) * 64) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) ÷ 8) % 2) * 32) ÷ 2) % 32) * 65 + (((((IndexSpaces.assume_inrange(t_outer,
                                    0,
                                    256,
                                    32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(t_inner,
                                    0,
                                    64,
                                    256) ÷ 64) % 4) * 64) ÷ 64) % 4) * 2081 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                    0,
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) ÷ 4) % 32 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                    0,
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) ÷ 2) % 2) * 32) + 0 + 0x01] = F̄_out_dish0
                                    F̄_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) % 2) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    ...
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 32) ÷ 4) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                    0,
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 32) ÷ 2) % 2) * 32) + 0 + 0x01] = F̄_out_dish32
                                    F̄_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) % 2) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    ...
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 64) ÷ 4) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                    0,
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 64) ÷ 2) % 2) * 32) + 0 + 0x01] = F̄_out_dish64
                                    F̄_shared[(((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    32) % 2) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                    0,
                                    ...
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 96) ÷ 4) % 32 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                    0,
                                    16) % 16) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                    0,
                                    128) % 4) * 128) + 96) ÷ 2) % 2) * 32) + 0 + 0x01] = F̄_out_dish96
                                    F_ringbuf_m0_dish0 = F_ringbuf_dish0_mtaps0
                                    F_ringbuf_m1_dish0 = F_ringbuf_dish0_mtaps1
                                    F_ringbuf_m2_dish0 = F_ringbuf_dish0_mtaps2
                                    F_ringbuf_m0_dish32 = F_ringbuf_dish32_mtaps0
                            ...
                            IndexSpaces.cuda_sync_threads()
                            Ē_dish0 = F̄_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) % 16) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 16) % 2) * 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) ÷ 8) % 16) * 64) ÷ 2) % 32) * 65 + (((((IndexSpaces.assume_inrange(t_outer,
                                                0,
                                                256,
                                                32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) ÷ 16) % 4) * 64) ÷ 64) % 4) * 2081 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                ...
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0x01]
                            Ē_dish2 = F̄_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) % 16) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 16) % 2) * 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                ...
                                                32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) ÷ 16) % 4) * 64) ÷ 64) % 4) * 2081 + ((((2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 4) % 32 + (((((2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0x01]
                            Ē_dish4 = F̄_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) % 16) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 16) % 2) * 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                ...
                                                32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) ÷ 16) % 4) * 64) ÷ 64) % 4) * 2081 + ((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 4) % 32 + (((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0x01]
                            Ē_dish6 = F̄_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) % 16) * 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 16) % 2) * 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                ...
                                                32768) ÷ 256) % 128) * 256 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(),
                                                0,
                                                16) ÷ 16) % 4) * 64) ÷ 64) % 4) * 2081 + ((((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 4) % 32 + (((((6 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
                                                0,
                                                128) % 4) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                0,
                                                32) ÷ 8) % 2) * 8) ÷ 2) % 2) * 32) + 0x01]
                            (Ē1_dish0, Ē1_dish2) = (IndexSpaces.get_lo16(Ē_dish0, Ē_dish2),
                                                    IndexSpaces.get_hi16(Ē_dish0, Ē_dish2))
                            (Ē1_dish4, Ē1_dish6) = (IndexSpaces.get_lo16(Ē_dish4, Ē_dish6),
                            ...
                            if t_outer ≥ 192
                                IndexSpaces.unsafe_store4_global!(Ē_memory,
                                                                  ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(),
                                                                                                 0,
                                                                                                 32) % 8) * 16 +
                                                                     (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(),
