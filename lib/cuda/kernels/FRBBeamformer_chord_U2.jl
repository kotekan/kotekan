...
@fastmath @inbounds(
    begin #= /localhome/eschnett/src/kotekan/julia/kernels/frb.jl:1882 =#
        ...
        if let
            ...
            W_polr0 = W_memory[((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 32) % 32) % 32) * 1152 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 144 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6) * 24 + ((0::Int32 % 2) % 2) * 576) + 0x01]
            W_polr1 = W_memory[((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 32) % 32) % 32) * 1152 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 144 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6) * 24 + ((1::Int32 % 2) % 2) * 576) + 0x01]
        end
        ...
        for t_outer in 0:48:16367
            ...
            let
                ...
                if true
                    Fsh1_shared[(((((((((((0::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((0::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((0::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((0::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((0::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    Fsh1_shared[(((((((((((4::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((4::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((4::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((4::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((4::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((4::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    Fsh1_shared[(((((((((((8::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((8::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((8::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((8::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((8::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((8::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    Fsh1_shared[(((((((((((12::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((12::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((12::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((12::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((12::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((12::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    Fsh1_shared[(((((((((((256::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((256::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((256::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((256::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((256::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((256::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish256_time0
                end
                if true
                    Fsh1_shared[(((((((((((260::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((260::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((260::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((260::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((260::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((260::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish260_time0
                end
                if true
                    Fsh1_shared[(((((((((((264::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((264::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((264::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((264::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((264::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((264::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish264_time0
                end
                if true
                    Fsh1_shared[(((((((((((268::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((268::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((268::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((268::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((268::Int32 ÷ 256) % 2) * 256) + (0::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((268::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish268_time0
                end
                if true
                    Fsh1_shared[(((((((((((0::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((0::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((0::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((0::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((0::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((0::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish0_time24
                end
                if true
                ...
                if true
                    Fsh1_shared[(((((((((((8::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((8::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((8::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((8::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((8::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((8::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish8_time24
                end
                if true
                    Fsh1_shared[(((((((((((12::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((12::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((12::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((12::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((12::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((12::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish12_time24
                end
                if true
                    Fsh1_shared[(((((((((((256::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((256::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((256::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((256::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((256::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((256::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish256_time24
                end
                if true
                    Fsh1_shared[(((((((((((260::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((260::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((260::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((260::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((260::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((260::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish260_time24
                end
                if true
                    Fsh1_shared[(((((((((((264::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((264::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((264::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((264::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((264::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((264::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish264_time24
                end
                if true
                    Fsh1_shared[(((((((((((268::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((268::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((268::Int32 ÷ 4) % 2) * 4) ÷ 8) % 64) * 257 + ((((((((268::Int32 ÷ 8) % 2) * 2 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 16) * 16) + ((268::Int32 ÷ 256) % 2) * 256) + (24::Int32 ÷ 24) % 2) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 16) % 2) * 8) + ((268::Int32 ÷ 4) % 2) * 4) % 8) * 32 + (((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 24) + 0) + 0x01] =
                        E_dish268_time24
                end
                    ...
                    for t_inner_lo in 0:4:23
                        ...
                        let t = 0
                            ...
                            if let
                                ...
                                G_beamQ0_polr0 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + ((0::Int32 % 2) % 2) * 32 + ((((((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4) + t::Int32 % 4) + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ24_polr0 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + ((0::Int32 % 2) % 2) * 32 + ((((((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4) + t::Int32 % 4) + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ0_polr1 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + ((1::Int32 % 2) % 2) * 32 + ((((((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4) + t::Int32 % 4) + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + (((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                                G_beamQ24_polr1 = Gsh_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8) % 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 8) % 2) * 1028 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) % 4) * 6 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 4) % 2) * 2056 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 2) % 2) * 4112 + ((1::Int32 % 2) % 2) * 32 + ((((((IndexSpaces.assume_inrange(t_outer::Int32, 0, 48, 16368) ÷ 48) % 341) * 48 + ((IndexSpaces.assume_inrange(t_inner_lo::Int32, 0, 4, 24) ÷ 4) % 6) * 4) + t::Int32 % 4) + ((t_inner_hi::Int32 ÷ 24) % 2) * 24) % 4) * 64 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 2) * 8256 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 16) % 2) * 514 + (((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) ÷ 32) % 2) * 257) + 0x01]
                            end
                                    ...
                                    if 0i32 ≤
                                       ...
                                       48
                                        I_memory[let
                                            ...
                                            length = 75497472
                                            mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 32) % 32) % 128) * 1152 + ((((0::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 48) * 24 + ((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 512) % 512) % 512) * 147456) + 0) + offset, length)
                                        end + 0x01] = I_beamQ0
                                    end
                                    if 0i32 ≤
                                       +(
                                       ...
                                       48
                                        I_memory[let
                                            offset = 147456 * Ttildemin + 1152 * Fbar_out_min
                                            length = 75497472
                                            mod((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 32) * 2) ÷ 2) % 24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx()::Int32, 0, 32) % 32) % 128) * 1152 + ((((24::Int32 ÷ 24) % 2) * 24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 24) % 24) % 48) * 24 + ((IndexSpaces.assume_inrange(dstime::Int32, 0, 1, 512) % 512) % 512) * 147456) + 0) + offset, length)
                                        end + 0x01] = I_beamQ24
                                    end
                                    I_beamQ0 = zero(Float16x2)
                                    I_beamQ24 = zero(Float16x2)
