    ...
    for T1 in 0:128:65535
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                ...
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((0::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish0_time0
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((0::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((4::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish4_time0
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((0::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((8::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish8_time0
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((0::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((12::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish12_time0
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((8::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish0_time8
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((8::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((4::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish4_time8
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((8::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((8::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                ...
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((8::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((12::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish12_time8
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((16::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish0_time16
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((16::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((4::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish4_time16
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((16::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((8::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                ...
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((16::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((12::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish12_time16
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((24::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish0_time24
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((24::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((4::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
                    E_dish4_time24
                E_shared[((((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((24::Int32 ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + ((((8::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0) + 0x01] =
            ...
            for T3 in 0:8:31
                let B = 0
                    ...
                    let D = 0
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[(((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 65 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 32 + ((D::Int32 ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64) + 0x01]
                    ...
                    Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 8) % 16 + ((0::Int32 % 2 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 2) % 32) * 20 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 128) % 2) * 640) + 0) + 0x01] =
                        Ju_time0
                    Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 8) % 16 + ((1::Int32 % 2 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 2) % 32) * 20 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 128) % 2) * 640) + 0) + 0x01] =
                        Ju_time1
                end
            end
            IndexSpaces.cuda_sync_threads()
            ...
            Ju_dish128_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4) % 16 + ((((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((0::Int32 ÷ 8) % 4) * 8 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128) % 32) * 20 + (((((128::Int32 ÷ 128) % 2) * 128) ÷ 128) % 2) * 640) + 0x01]
