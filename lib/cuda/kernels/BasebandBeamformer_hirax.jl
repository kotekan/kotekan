    ...
    for T1 in 0:128:65535
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                ...
                E_shared[((((((0::Int32 ÷ 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128) ÷ 4) % 64 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) ÷ 2) % 2) * 4 + ((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 8) % 4 + ((0::Int32 ÷ 8) % 4) * 8) % 32) * 65) + 0) + 0x01] =
                    E_dish0_time0
            ...
            for T3 in 0:8:31
                let B = 0
                    ...
                    let D = 0
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx()::Int32, 0, 4) % 2) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) % 4) * 32 + ((D::Int32 ÷ 4) % 8) * 4) ÷ 4) % 64 + ((((IndexSpaces.assume_inrange(T1::Int32, 0, 128, 65536) ÷ 128) % 512) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx()::Int32, 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(T2::Int32, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3::Int32, 0, 8, 32) ÷ 8) % 4) * 8) % 32) * 65) + 0x01]
