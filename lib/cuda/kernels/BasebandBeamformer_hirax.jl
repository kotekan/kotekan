...
@inbounds begin #= /home/eschnett/src/kotekan/julia/kernels/bb.jl:890 =#
    ...
    s = s_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) ÷ 32) % 64) % 64) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) ÷ 16) % 2) % 2) * 16) + 0x01]
    s = s - 3
    if !(0i32 < s < 32i32)
        info = 2
        if true
    ...
    for T1 in 0:128:127
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 4
                    ...
                    (
                        ...
                        (
                            (
                                (
                                    (
                                        (8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) +
                                        (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4
                                    ) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128
                            ) % 2048
                    ...
                    (
                        ...
                        (
                            (
                                (
                                    (
                                        (16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) +
                                        (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4
                                    ) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128
                            ) % 2048
                    ...
                    (
                        ...
                        (
                            (
                                (
                                    (
                                        (24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) +
                                        (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4
                                    ) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128
                            ) % 2048
                ...
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish0_time0
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish4_time0
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish8_time0
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 12) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish12_time0
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish0_time8
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish4_time8
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish8_time8
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 12) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish12_time8
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish0_time16
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish4_time16
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish8_time16
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 12) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish12_time16
                end
                if true
                    E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish0_time24
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish4_time24
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish8_time24
                end
                if true
                    E_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + 12) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 4) % 64 + (((((24 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0) + 0x01] =
                        E_dish12_time24
                end
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) + ((D ÷ 4) % 8) * 4) ÷ 4) % 64 + ((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 65) + 0x01]
                    ...
                    if true
                        Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 8) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 128) % 2) * 640 + ((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0) + 0x01] =
                            Ju_time0
                    end
                    if true
                        Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) ÷ 2) % 2) * 8) % 16 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 2) * 128) ÷ 128) % 2) * 640 + (((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + 1) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0) + 0x01] =
                            Ju_time1
                    end
                end
            end
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 0 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish128_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 640 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish0_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 0 + ((((8 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish128_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 640 + ((((8 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish0_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 0 + ((((16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish128_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 640 + ((((16 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish0_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 0 + ((((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
            Ju_dish128_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 4) % 4) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 16 + 640 + ((((24 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 2048) % 16) * 128) % 32) * 20) + 0x01]
