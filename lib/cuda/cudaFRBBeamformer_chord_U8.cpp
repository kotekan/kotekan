...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 24 * 24 * 2 * 128;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 48 * 48 * 128 * 512;
    ...
    static constexpr std::size_t info_length = chord_datatype_bytes(info_type) * 32 * 24 * 128;
