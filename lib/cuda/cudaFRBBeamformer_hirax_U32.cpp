...
private:
    ...
    static constexpr std::size_t W32_length =
        chord_datatype_bytes(W32_type) * 2 * 16 * 16 * 2 * 2048;
    ...
    static constexpr std::size_t Ebar32_length =
        chord_datatype_bytes(Ebar32_type) * 256 * 2 * 2048 * 1024;
    ...
    static constexpr std::size_t I32_length = chord_datatype_bytes(I32_type) * 32 * 32 * 2048 * 128;
