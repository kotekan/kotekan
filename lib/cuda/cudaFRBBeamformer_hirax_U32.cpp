...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 16 * 16 * 2 * 2048;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 32 * 32 * 2048 * 128;
