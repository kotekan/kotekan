...
private:
    ...
    static constexpr std::size_t W8_length = chord_datatype_bytes(W8_type) * 2 * 16 * 16 * 2 * 512;
    ...
    static constexpr std::size_t Ebar8_length =
        chord_datatype_bytes(Ebar8_type) * 256 * 2 * 512 * 4096;
    ...
    static constexpr std::size_t I8_length = chord_datatype_bytes(I8_type) * 32 * 32 * 512 * 512;
