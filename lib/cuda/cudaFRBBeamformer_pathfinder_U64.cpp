...
private:
    ...
    static constexpr std::size_t W64_length =
        chord_datatype_bytes(W64_type) * 2 * 8 * 12 * 2 * 24576;
    ...
    static constexpr std::size_t Ebar64_length =
        chord_datatype_bytes(Ebar64_type) * 64 * 2 * 24576 * 512;
    ...
    static constexpr std::size_t I64_length = chord_datatype_bytes(I64_type) * 16 * 24 * 24576 * 64;
