...
private:
    ...
    const char* const kernel_symbol =
        "_Z8upchan645Int32S_S_S_S_S_13CuDeviceArrayI9Float16x2Ll1ELl1EES0_I6Int4x8Ll1ELl1EES0_IS2_"
    ...
    static constexpr std::ptrdiff_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 64 * 2 * 2048 * 512;
...
cudaUpchannelizer_pathfinder_U64::execute(cudaPipelineState& /*pipestate*/,
    ...
    *Ebar_meta = *E_meta;
    ...
    DEBUG("Finished CUDA Upchannelizer_pathfinder_U64 on GPU frame {:d}", gpu_frame_id);
