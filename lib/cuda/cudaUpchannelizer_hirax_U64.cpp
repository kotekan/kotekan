...
private:
    ...
    static constexpr std::size_t G_length = chord_datatype_bytes(G_type) * 4096;
    ...
    static constexpr std::size_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 256 * 2 * 4096 * 128;
    ...
    static constexpr std::size_t info_length = chord_datatype_bytes(info_type) * 32 * 16 * 256;
