...
private:
    ...
    static constexpr std::ptrdiff_t G_U16_length = chord_datatype_bytes(G_U16_type) * 128;
    ...
    static constexpr std::ptrdiff_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 512 * 2 * 128 * 2048;
...
cudaEvent_t cudaUpchannelizer_chord_U16::execute(cudaPipelineState& /*pipestate*/,
    ...
    *Ebar_meta = *E_meta;
    ...
    DEBUG("Finished CUDA Upchannelizer_chord_U16 on GPU frame {:d}", gpu_frame_id);
