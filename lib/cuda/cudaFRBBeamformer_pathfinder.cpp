...
private:
    ...
    static constexpr std::size_t E_length = chord_datatype_bytes(E_type) * 64 * 2 * 2048 * 2064;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 16 * 24 * 51 * 2048;
