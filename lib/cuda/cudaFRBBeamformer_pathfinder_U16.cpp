...
private:
    ...
    static constexpr std::size_t W_length = chord_datatype_bytes(W_type) * 2 * 8 * 12 * 2 * 6144;
    ...
    static constexpr std::size_t Ebar_length =
        chord_datatype_bytes(Ebar_type) * 64 * 2 * 6144 * 2048;
    ...
    static constexpr std::size_t I_length = chord_datatype_bytes(I_type) * 16 * 24 * 6144 * 256;
