...
cudaCHIMEFRBBeamform::cudaCHIMEFRBBeamform(kotekan::Config& config, const std::string& unique_name,
    ...
    frb1_beams(frb1_beams_name, "frb1",
               ...
               std::array<std::string, 5>{"T", "F", "P", "EW", "NS"},
               std::array<std::ptrdiff_t, 5>{1, 1, 1, 1, 1}, *this),
