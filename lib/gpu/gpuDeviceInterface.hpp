...
public:
    ...
    /**
     * @brief Get one of the gpu memory pointers with the given name and size = len at the given index
     * The size of the set is equal to _gpu_buffer_depth, so index < _gpu_buffer_depth
