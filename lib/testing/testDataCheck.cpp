...
using testDataCheckUlong = testDataCheck<uint64_t>;
using testDataCheckLong = testDataCheck<int64_t>;
...
REGISTER_KOTEKAN_STAGE(testDataCheckUlong);
REGISTER_KOTEKAN_STAGE(testDataCheckLong);
