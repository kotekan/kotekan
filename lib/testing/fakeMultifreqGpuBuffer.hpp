/*****************************************
@file
@brief Generate fake data in gpu buffer format, with multiple freqs per buffer.
- fakeMultifreqGpuBuffer : public KotekanProcess
*****************************************/
 ...
 * @author Richard Shaw
 */
class fakeMultifreqGpuBuffer : public KotekanProcess {
public:

    fakeMultifreqGpuBuffer(Config& config,
                const string& unique_name,
                bufferContainer &buffer_container);
    ~fakeMultifreqGpuBuffer();
...
private:
    ...
    typedef void(fakeMultifreqGpuBuffer::*fill_func)(int32_t *, int, chimeMetadata *);
