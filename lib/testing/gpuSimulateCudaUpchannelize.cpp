...
void gpuSimulateCudaUpchannelize::upchan_simple(std::string tag, const float16_t *__restrict__ const W,
                                                const float16_t *__restrict__ const G,
                                                //const storage_t *__restrict__ const E,
                                                //storage_t *__restrict__ const Ebar,
...
{}
void gpuSimulateCudaUpchannelize::upchan_simple_sub(std::string tag, const float16_t *__restrict__ const W,
                                                    const float16_t *__restrict__ const G,
                                                    //const storage_t *__restrict__ const E,
                                                    //storage_t *__restrict__ const Ebar,
                                                    const void* __restrict__ const E,
...
void gpuSimulateCudaUpchannelize::main_thread() {
    ...
    while (!stop_thread) {
        ...
        INFO("Simulating GPU processing for {:s}[{:d}] putting result in {:s}[{:d}]",
             voltage_in_buf->buffer_name, voltage_frame_id, voltage_out_buf->buffer_name, output_frame_id);
        ...
        if (!done) {
            //upchan_simple(id_tag, phase, voltage, shift, output, _samples_per_data_set, _num_beams,
