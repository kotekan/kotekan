...
static __device__ int lop3(int a, int b, int c) {
    ...
    asm("lop3.b32 %0, %1, %2, %3, %4;" : "=r"(d) : "r"(a), "r"(b), "r"(c), "n"(immLut));
...
template<uint B>
struct _bit_selector;
template<>
struct _bit_selector<1> {
    static constexpr uint value = 0xaaaaaaaaU;
}; // 0xa = (1010)_2
template<>
struct _bit_selector<2> {
    static constexpr uint value = 0xccccccccU;
}; // 0xc = (1100)_2
template<>
struct _bit_selector<4> {
    static constexpr uint value = 0xf0f0f0f0U;
};
template<>
struct _bit_selector<8> {
    static constexpr uint value = 0xff00ff00U;
};
template<>
struct _bit_selector<16> {
    static constexpr uint value = 0xffff0000U;
};
...
template<uint B>
__device__ uint _transpose_bit_with_lane(uint x, uint y, bool upper) {
